...
/*
 * Siblings by relative path, not the package barrel — this file is exported
 * from `index.ts`, so importing the barrel here is a cycle. Inside `src/web`,
 * always reach for the module.
 */
