...
describe("validateHandleFormat", () => {
  ...
  /*
   * "Reserves every route the app actually serves" lives in
   * `apps/web/src/lib/handle-routes.test.ts`. It reads that app's `src/app`
   * off disk, and there is no route tree on this side of the boundary to read.
   */
