 ...
 *
 * What deliberately did **not** move: `platform`, `connect` and `memberships`.
 * Those are orchestrators — they take a verified event and fan out into stock,
 * downloads, invoices, buyer and seller email, outbound seller webhooks and the
 * partner ledger. Lifting them would mean either copying half of apps/web in
 * behind them or inverting those calls behind an interface, and inverting them
 * is a refactor of the money path. They stay in apps/web and import this
 * package's seam; see `apps/web/src/lib/stripe-webhooks/index.ts`.
 *
