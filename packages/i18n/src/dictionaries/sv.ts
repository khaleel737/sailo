...
export const sv: Dictionary = {
  ...
  shop: {
    ...
    kindMembershipMonth: "Förnyas varje månad",
    kindMembershipYear: "Förnyas varje år",
    perMonth: "per månad",
    perYear: "per år",
  ...
  checkout: {
    ...
    shipTo: "Vart ska det skickas?",
    noShippingTo: "{shop} skickar inte till {country} än.",
    chooseCountryFirst: "Välj ett land för att se leveransalternativen.", notes: "Storlek, färg, leveransnoteringar…",
  ...
  rails: {
    ...
    cardDesc: "Kort, Apple Pay, Google Pay, Link och Cash App Pay — du ser de som finns där du är.",
    ...
    venmoAction: "Betala med Venmo",
    venmoDesc: "Öppnar Venmo med beloppet ifyllt. Kom tillbaka hit för att bekräfta.",
    paypalAction: "Betala med PayPal",
    paypalDesc: "Öppnar PayPal med beloppet ifyllt. Kom tillbaka hit för att bekräfta.",
    shippingName: "Frakt",
  ...
  onboarding: {
    ...
    customize: "Gör den till din",
    customizeTitle: "Anpassa din butik",
    customizeSubtitle: "Välj din färg, lägg till ett foto och ställ in valutan du säljer i.",
    themeColor: "Temafärg",
    useColor: "Använd {color}",
    customColor: "Välj en egen färg",
    uploadPhoto: "Lägg till foto",
    removePhoto: "Ta bort foto",
    photoError: "Det fotot kan inte användas — prova en JPG- eller PNG-bild.",
  },
  handle: {
  ...
  membership: {
    ...
    activeUntil: "Aktivt — förnyas {date}.",
    endingOn: "Slutar {date}. Du har tillgång fram till dess.",
    pastDue: "Vi kunde inte dra den senaste betalningen. Vi försöker igen — uppdatera gärna ditt kort.",
    ended: "Det här medlemskapet har avslutats.",
  ...
  dataRequest: {
    title: "Begär dina uppgifter",
    body: "Be {shop} om en kopia av det de har om dig, eller be om att det raderas.",
    emailLabel: "E-postadressen du använde",
    kindLabel: "Vad begär du?",
    kindAccess: "En kopia av det ni har om mig",
    kindPortability: "En flyttbar kopia jag kan ta med mig",
    kindErasure: "Radera det ni har om mig",
    cta: "Skicka min begäran",
    received: "Tack. Om vi har något för den adressen har vi skickat en länk dit så att du kan bekräfta att det är du. Ingenting händer förrän du klickar på den.",
    note: "Detta gäller bara den här butiken. Andra butiker på Sailo har sina egna separata uppgifter och måste tillfrågas var för sig.",
    confirmed: "Bekräftat — tack",
    confirmedBody: "{shop} har {days} dagar på sig att svara. Vi mejlar dig på den här adressen när det sker.",
    badLink: "Den här länken öppnar ingenting",
    badLinkBody: "Den kan ha gått ut eller redan använts. Begär igen från {shop}s sida så skickar vi en ny länk.",
    unavailable: "Vi kunde inte kontrollera det just nu. Försök igen om en stund.",
    footerLink: "Begär dina uppgifter",
  },
  lead: {
    submit: "Skicka det till mig",
    sending: "Skickar…",
    thanks: "Tack! Kolla inkorgen — det är på väg.",
    thanksNoFile: "Tack! {shop} har dina uppgifter.",
    answerRequired: "Svara gärna: {question}",
    privacy: "Dina uppgifter går bara till den här butiken, och du kan när som helst be att få dem raderade.",
  },
  stock: {
    tellMe: "Säg till när den är tillbaka",
    emailPlaceholder: "you@example.com",
    contactPlaceholder: "E-post eller telefon",
    notifyMe: "Meddela mig",
    queued: "Vi hör av oss när den är tillbaka. Vi har inte lagt undan någon — vem som helst kan köpa den.",
    onceOnly: "Ett meddelande, när den är tillbaka. Inget annat. {shop}",
    tryAgain: "Det gick inte just nu. Försök igen om en stund.",
