...
export const en = {
  ...
  onboarding: {
    ...
    customizeTitle: "Customize your shop",
    customizeSubtitle:
      "Pick your colour, add a photo, and set the currency you sell in.",
    themeColor: "Theme colour",
    /** Accessible name for one preset swatch; {color} is a hex code. */
    useColor: "Use {color}",
    customColor: "Pick a custom colour",
    uploadPhoto: "Add photo",
    removePhoto: "Remove photo",
    photoError: "That photo can't be used — try a JPG or PNG image.",
