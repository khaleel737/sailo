...
export const nl: Dictionary = {
  ...
  onboarding: {
    ...
    shortDescription: "Korte omschrijving", currency: "Valuta",
    ...
    customize: "Maak hem van jou",
    customizeTitle: "Personaliseer je winkel",
    customizeSubtitle: "Kies je kleur, voeg een foto toe en stel de valuta in waarin je verkoopt.",
    themeColor: "Themakleur",
    useColor: "{color} gebruiken",
    customColor: "Kies een eigen kleur",
    uploadPhoto: "Foto toevoegen",
    removePhoto: "Foto verwijderen",
    photoError: "Die foto kan niet worden gebruikt — probeer een JPG- of PNG-afbeelding.",
  },
  handle: {
