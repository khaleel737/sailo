...
import {
  ...
  orderPayload,
  type WebhookEvent,
} from "@sailo/core/webhook-events";
 ...
 * could see from the app. The catalogue and the envelope stayed behind in
 * `@sailo/core/webhook-events`, which a browser may import; this half writes to
 * the database and may not.
 *
