...
import { HqSidebar } from "@/app/_components/hq-sidebar";
import { PanelFooter } from "@sailo/design-system/web/panel-footer";
 ...
 */
export default async function HqLayout({ children }: LayoutProps<"/">) {
