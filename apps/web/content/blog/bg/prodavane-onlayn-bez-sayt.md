...
За да имаш бутон за карта в Sailo, ти трябва едно нещо: свързан акаунт в Stripe, одобрен да приема плащания. Комисионата на Sailo е {{fee_range}}% върху стойността на продуктите след отстъпка, без доставката и без данъците. Парите не минават през Sailo, влизат в твоя собствен Stripe акаунт.
...
Безплатният план спира на {{free_products}} продукта, с {{free_analytics_days}} дни статистика. Pro е {{pro_monthly}} USD на месец или {{pro_yearly}} USD на година, с {{pro_products}} продукта и износ в CSV, и не включва карта. Картата е на всеки план; планът определя само комисионата.
