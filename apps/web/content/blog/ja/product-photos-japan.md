...
Sailo の無料プランは商品{{free_products}}点までです。ヴィンテージのような一点ものを扱っていると、{{free_products}}点はあっという間に埋まります。売れた商品を消せば枠は空きますが、消すと過去の写真も一覧から消えます。Pro は ${{pro_monthly}}/月（年払い ${{pro_yearly}}）で{{pro_products}}点、Business は ${{business_monthly}}/月（年払い ${{business_yearly}}）で上限なし。一点ものを扱う人にとっては、この上限がプランを決める理由になります。
