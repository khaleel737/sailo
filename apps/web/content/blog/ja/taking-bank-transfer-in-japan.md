...
カード決済に逃げるという手はあります。Sailo でカードを使うには Business プラン（${{business_monthly}}/月、年払い ${{business_yearly}}）と、Stripe に承認された接続済みアカウントの両方が必要です。手数料は商品代の {{fee_range}}%（割引後の商品代にかかり、送料と税は対象外）で、お金はあなたの Stripe アカウントに直接入ります。
