...
Sailo のカード決済は Business プラン（${{business_monthly}}/月、年払いなら ${{business_yearly}}）と、Stripe に承認された接続済みアカウントの両方が要ります。手数料は商品代の {{fee_range}}% で、これはどのプランでも同じ率です。割引後の商品代にかかり、送料と税は対象外。お金は Sailo を経由せず、あなたの Stripe アカウントに直接入ります。
...
ここで、料金の設計に効いてくる小さな事実がひとつあります。カード決済の {{fee_range}}% は商品代にかかり、送料には**かかりません**。送料を商品価格に埋め込むと、その埋め込んだ分にも {{fee_range}}% が乗ります。¥800 の送料を価格に混ぜると、一件あたり 4円。件数が少ないうちは誤差ですが、どちらの見せ方が自分に合うかを決めるときの材料にはなります。
...
無料プランは $0 で、商品{{free_products}}点まで。分析データは{{free_analytics_days}}日分。チャット系と手動の支払い方法は使えますが、カード決済はありません。

Pro は ${{pro_monthly}}/月（年払い ${{pro_yearly}}）で商品{{pro_products}}点、分析1年、Sailo のバッジが消えて、CSV書き出しがつきます。カード決済はここにも**ありません**。

Business は ${{business_monthly}}/月（年払い ${{business_yearly}}）で商品数の上限なし、分析3年、カード決済、クーポン、アフィリエイト。

正直な制限を三つ。**無料プランの{{free_products}}点は、色違いやサイズ違いを別商品にしていると、思ったより早く埋まります。**手動の支払い方法は、確認する人があなたしかいません。そして、日本で標準的な連絡手段であるLINEの導線が無い。
