...
無料プランは $0 で商品{{free_products}}点まで、分析は{{free_analytics_days}}日分。手動の支払い方法とチャット経由の注文は使えますが、カード決済はありません。カードを出すには Business プラン（${{business_monthly}}/月、年払い ${{business_yearly}}）と、Stripe に承認された接続済みアカウントの両方が必要です。手数料は商品代の {{fee_range}}%（割引後の商品代にかかり、送料と税は対象外）。
