---
title: Poste o corriere privato, la risposta dipende da dove spedisci
description: Non esiste il corriere migliore in assoluto. Esiste quello giusto per la tua mappa di CAP, e c'è un modo per capire in mezz'ora qual è il tuo.
date: 2026-08-06
author: Sailo team
cover: /blog/covers/poste-o-corriere-privato.svg
coverAlt: Una cartina d'Italia con dei pacchi appoggiati sopra in punti diversi del paese
tags: [spedizioni, corrieri, logistica]
---
...
## Quello che i due fanno davvero, senza tifo
...
## Il pulsante più grosso non è il corriere, è il contratto
...
## Cosa guardare quando apri un listino
...
## Il tempo di consegna, detto in modo onesto
...
## La procedura per decidere, in mezz'ora
...
## La soluzione che quasi tutti trovano alla fine
...
- **Il corriere privato per i grandi centri e per tutto ciò che ha fretta.** È dove ti dà velocità, avvisi al destinatario e fasce orarie, e dove quel vantaggio si sente.
- **Poste per i paesi piccoli, per l'entroterra e per le zone dove il privato affida a terzi.** È dove il portalettere passa comunque, e dove il tuo pacco non finisce in un punto di ritiro a venti chilometri da un cliente che non ha la macchina.
...
## Se accetti il contrassegno, il conto cambia
...
I conti completi, compreso quando conviene rifiutare il pagamento alla consegna, stanno in [contrassegno come funziona, visto da chi vende](/it/blog/contrassegno-come-funziona).
...
Sul bonifico e sul contrassegno Sailo non prende nessuna commissione e non tocca mai il denaro. L'unica commissione esistente è lo 0,5% sul valore dei prodotti quando si paga con carta, calcolata dopo lo sconto e **esclusa la spedizione**, e la carta richiede il piano Business da 19,99 USD al mese con un account Stripe approvato.
...
Terzo, controlla che quello che incassi di spedizione copra davvero quello che paghi, zona per zona e non in media, perché è lì che il margine sparisce in silenzio: il metodo sta in [come calcolare le spese di spedizione](/it/blog/calcolare-le-spese-di-spedizione).

Se stai ancora costruendo il sistema attorno agli ordini invece che attorno ai pacchi, l'ordine di montaggio completo è in [vendere su Instagram senza sito](/it/blog/vendere-su-instagram-senza-sito). E se il problema vero non è la logistica ma il fatto che gli ordini sono ancora pochi, la logistica può aspettare: comincia da [come arrivano i primi ordini online](/it/blog/primi-ordini-online).
