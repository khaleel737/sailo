---
title: Come fare i prezzi nell'artigianato senza lavorare gratis
description: Materiali, ore, costi nascosti e il moltiplicatore che non funziona. Come si ricostruisce un prezzo, come si alza, e cosa fare se il mercato non ci arriva.
date: 2026-08-06
author: Sailo team
cover: /blog/covers/come-fare-i-prezzi-artigianato.svg
coverAlt: Un banco da lavoro con gomitoli, una calcolatrice e un cartellino del prezzo scritto a mano
tags: [prezzi, artigianato, margine]
---
...
## I materiali al costo vero, non al costo del cartellino
...
## Le tue ore, che non valgono zero
...
## I costi fissi, divisi per i pezzi veri
...
## Il conto completo, e la cosa che scopri facendolo
...
1. **Ridurre le ore.** Un punto più veloce, un ferro più grosso, un modello più corto. Se la sciarpa scende a quattro ore, il costo scende a circa 80 € e il prezzo diventa raggiungibile.
2. **Cambiare a chi la vendi.** Chi paga 140 € per una sciarpa fatta a mano esiste, ma non passa per caso davanti a un banco al mercatino di paese.
3. **Tenerla come pezzo di punta e guadagnare sul resto.** Il pezzo lento fa da vetrina e giustifica la fascia di prezzo, mentre il fatturato lo fanno i pezzi veloci. Chiara ha aggiunto scaldacollo da due ore a 38 € e fascette da un'ora a 22 €. È la scelta che ha fatto, ed è quella che funziona più spesso.

## Perché «costo per tre» si rompe
...
## Quello che il mercato italiano ti mette contro
...
## Come si alza un prezzo su un prodotto che vendi da due anni
...
## Cosa fa Sailo qui, e cosa non fa
...
Sulle vendite incassate con bonifico o contrassegno Sailo non prende nessuna commissione e non tocca mai il denaro. L'unica commissione esistente è lo {{fee_range}}% sul valore dei prodotti quando il pagamento è con carta, e la carta richiede un account Stripe approvato.
...
E prima di considerare finito il conto, controlla che la spedizione non ti stia mangiando quello che hai appena sistemato, perché è il posto dove i margini spariscono più in silenzio: i numeri stanno in [come calcolare le spese di spedizione](/it/blog/calcolare-le-spese-di-spedizione). Un prezzo alto ha bisogno di foto che lo reggano, e il metodo con un telefono e una finestra è in [fotografare i prodotti col telefono](/it/blog/fotografare-i-prodotti-col-telefono). Sopra i cento euro il metodo di pagamento cambia, e le frasi giuste stanno in [farsi pagare con bonifico senza rincorrere nessuno](/it/blog/farsi-pagare-con-bonifico). Il quadro completo di come si vende partendo da un profilo social è in [vendere su Instagram senza sito](/it/blog/vendere-su-instagram-senza-sito).
