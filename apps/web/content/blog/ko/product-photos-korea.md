...
그리고 무료 플랜은 상품 {{free_products}}개까지입니다. 색상마다 상품을 따로 만드는 방식이면 벽이 금방 옵니다. 한소영 씨처럼 5종 색상을 하나의 상품 안에서 옵션으로 처리하면 여유가 있지만, 색상별로 나눠 등록하면 네 가지 모델만 올려도 스무 개가 찹니다. {{pro_products}}개까지 필요하면 Pro가 월 ${{pro_monthly}} 또는 연 ${{pro_yearly}}이고, 무제한은 Business로 월 ${{business_monthly}} 또는 연 ${{business_yearly}}입니다.
