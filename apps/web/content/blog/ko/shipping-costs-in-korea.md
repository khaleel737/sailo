...
마지막 줄에 대해 덧붙이면, 사일로에서 카드 결제를 쓰려면 Business 플랜이 필요합니다. 월 ${{business_monthly}} 또는 연 ${{business_yearly}}이고, 결제 승인을 받은 Stripe 계정을 연결해야 합니다. 카드 대금은 사일로를 거치지 않고 판매자 본인의 Stripe 계정으로 들어갑니다.
