...
**Tarjeta.** En Sailo el botón de tarjeta funciona sobre Stripe y solo sobre Stripe. Requiere una cuenta de Stripe aprobada para aceptar cargos. Sailo cobra un {{fee_range}}% sobre el importe de los productos después de descuentos, sin contar envío ni impuestos, y a eso se le suma la comisión propia de Stripe. El dinero va directo a tu cuenta de Stripe, nunca pasa por Sailo. En España Stripe está disponible, así que aquí la decisión es económica y no de disponibilidad: en un pedido de 39 €, los 20 céntimos de Sailo son irrelevantes y lo que decide es si la suscripción de {{business_monthly}} USD al mes se justifica con tu volumen. Con veinte pedidos al mes, probablemente no. Con doscientos, probablemente sí.
