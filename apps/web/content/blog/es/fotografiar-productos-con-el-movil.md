---
title: Cómo fotografiar productos con el móvil
description: Una ventana, una superficie y seis fotos por producto. El método que hace que una ficha se entienda en miniatura y deje de generar preguntas y devoluciones.
date: 2026-08-06
author: Sailo team
cover: /blog/covers/fotografiar-productos-con-el-movil.svg
coverAlt: Un objeto sobre una mesa junto a una ventana con la luz entrando de lado
tags: [fotografia, producto]
---
...
## Las seis fotos que sostienen una ficha

Un producto necesita seis imágenes. No treinta, y tampoco una.

1. **La principal, limpia.** El producto entero sobre fondo neutro, centrado, bien iluminado. Es la que va en la miniatura y la que decide si alguien entra.
2. **El ángulo de 45 grados.** Como lo verías sentado en una mesa. Da profundidad y es la que hace que un objeto parezca real.
3. **El detalle.** El esmalte, la costura, el grano de la madera, el cierre. Acércate hasta que llene el encuadre, y luego acércate más.
4. **La escala.** El producto junto a algo cuyo tamaño todo el mundo conoce, o en una mano.
5. **En uso.** El bol con cereales, el jersey puesto, la vela encendida. Esta es la que la gente comparte.
6. **El conjunto.** Si hay variantes de color o tamaño, una foto con todas juntas. Ahorra la pregunta de «¿en qué colores lo tienes?».
...
## La escala es la pregunta que más te van a escribir
...
## El fondo: dos cartulinas y se acabó
...
## Los tres ajustes del móvil que importan
...
## La edición son dos deslizadores
...
## Dispara pensando en la miniatura
...
Esa foto y el precio son los dos elementos que deciden si alguien se detiene. Qué más va en esa página y en qué orden está en [qué poner en el link de la bio](/es/blog/que-poner-en-el-link-de-la-bio).

Fotografía también tu embalaje cerrado, con la caja que usas de verdad. Sirve para la ficha, sirve para las historias, y de paso te obliga a mirar el tamaño real de la caja, que es el número que decide tu coste de envío. La fórmula está en [cómo calcular el envío](/es/blog/como-calcular-el-envio).

## Nuria, cerámica en Valencia
...
## Cuántas fotos hacen falta de verdad
...
Hay un límite práctico que ayuda aquí más de lo que estorba: el plan gratuito de Sailo permite 20 productos y guarda 30 días de estadísticas. Si tienes 45 referencias, vas a tener que elegir 20, y elegir 20 es exactamente el ejercicio que deberías hacer aunque no hubiera límite. El plan Pro cuesta 9,99 USD al mes o 95,90 USD al año y sube a 250 productos, un año de estadísticas y exportación en CSV; el plan Business, a 19,99 USD al mes, quita el límite y añade el cobro con tarjeta.
