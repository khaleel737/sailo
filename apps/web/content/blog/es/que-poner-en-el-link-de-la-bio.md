---
title: Qué poner en el link de la bio
description: Un comprador decide en la primera pantalla. Estos son los seis bloques que sirven, en qué orden van y qué puedes borrar sin perder una sola venta.
date: 2026-08-06
author: Sailo team
cover: /blog/covers/que-poner-en-el-link-de-la-bio.svg
coverAlt: Una pantalla de teléfono con una tienda que muestra productos y precios sin desplazarse
tags: [biografia, conversion]
---
...
## Las tres preguntas que se contestan antes del primer desplazamiento
...
## Los seis bloques que sirven, en este orden
...
## Lo que puedes borrar sin perder una sola venta

Esta lista incomoda a mucha gente porque son las cosas en las que más tiempo se invierte.

- **El párrafo sobre tu historia, arriba.** No lo borres del todo, bájalo. Quien llegó desde la foto de una vela quiere la vela. Tu historia importa después de que le gustó el producto, no antes.
- **Los botones de redes sociales, arriba.** Esa persona ya viene de tu red social. Un botón a Instagram en la parte superior de tu tienda es una salida de emergencia que instalaste tú mismo.
- **El formulario de suscripción emergente.** En un teléfono ocupa la pantalla completa y aparece justo cuando la persona iba a mirar los precios.
- **«Escríbeme para más información».** Traducido: no puse la información.
- **Un catálogo en PDF.** Se descarga, se abre en otra aplicación, se ve minúsculo y no tiene botón de compra.
- **Un enlace a un formulario de Google.** Funciona para inscripciones. Para comprar, pide una fe que nadie tiene a las diez de la noche.

## Un árbol de enlaces no es una tienda
...
## Los tres números que faltan siempre
...
## El nombre del enlace también comunica
...
## Si vendes servicios o archivos, la página lleva otras cosas
...
## Lo que el enlace no puede arreglar

Una página ordenada convierte mejor a quien ya llegó. No trae a nadie.

Si tienes 400 visitas al mes, reordenar la página te puede llevar de 10 a 18 pedidos. No te va a llevar a 60. Para eso hace falta que más gente llegue, que es un trabajo distinto y está en [cómo conseguir los primeros pedidos](/es/blog/como-conseguir-los-primeros-pedidos).

Y hay un límite práctico que conviene conocer antes de empezar a cargar productos: el plan gratuito de Sailo permite {{free_products}} productos y guarda {{free_analytics_days}} días de estadísticas. Para la mayoría es suficiente y hasta saludable, porque obliga a elegir. Pero si vendes ropa y cada talla y color es un producto separado, 20 se te acaban en una colección. El plan Pro cuesta {{pro_monthly}} USD al mes o {{pro_yearly}} USD al año, sube a {{pro_products}} productos, guarda un año de estadísticas, quita el distintivo de Sailo de la página y permite exportar en CSV. Los dos incluyen cobro con tarjeta, al {{fee_free}}% en el gratuito y al {{fee_pro}}% en Pro, y además necesita una cuenta de Stripe aprobada, que no está disponible en todos los países de la región.
...
Si dudaste en alguna, ya sabes cuál es el bloque que hay que mover. Sube los productos, baja todo lo demás, y agrega la línea de envío arriba. Después revisa las fotos, porque una ficha con precio y una foto oscura sigue sin vender: el método de una sola ventana está en [cómo fotografiar productos con el móvil](/es/blog/fotografiar-productos-con-el-movil).

Cuando la página esté lista, lo siguiente es qué pasa después del toque de comprar. El recorrido completo, desde la publicación hasta el pedido escrito, está en [cómo vender por Instagram sin página web](/es/blog/como-vender-por-instagram-sin-pagina-web), y si tus pedidos van a caer en el chat, [cómo vender por WhatsApp](/es/blog/como-vender-por-whatsapp) tiene el mensaje de confirmación que cierra el ciclo.
