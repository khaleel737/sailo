...
Y hay un límite práctico que conviene conocer antes de empezar a cargar productos: el plan gratuito de Sailo permite {{free_products}} productos y guarda 30 días de estadísticas. Para la mayoría es suficiente y hasta saludable, porque obliga a elegir. Pero si vendes ropa y cada talla y color es un producto separado, 20 se te acaban en una colección. El plan Pro cuesta {{pro_monthly}} USD al mes o {{pro_yearly}} USD al año, sube a {{pro_products}} productos, guarda un año de estadísticas, quita el distintivo de Sailo de la página y permite exportar en CSV. Ninguno de los dos incluye cobro con tarjeta: eso solo está en Business, a {{business_monthly}} USD al mes, y además necesita una cuenta de Stripe aprobada, que no está disponible en todos los países de la región.
