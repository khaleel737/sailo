---
title: Cómo vender por WhatsApp sin perder pedidos en el camino
description: Configuración, catálogo, mensaje de confirmación y cobro. Lo que hace que un pedido llegue escrito en vez de repartido en veinte mensajes sueltos.
date: 2026-08-06
author: Sailo team
cover: /blog/covers/como-vender-por-whatsapp.svg
coverAlt: Varias conversaciones que desembocan en una sola página de pedido con un total visible
tags: [whatsapp, pedidos]
---
...
## Un chat vacío es un formulario sin campos
...
## Cambia a WhatsApp Business y configura cuatro cosas
...
**El perfil de negocio.** Nombre, categoría, horario, dirección si tienes local, y un enlace. Ese enlace tiene que ir a tu catálogo con precios, no a una lista de botones. Alguien que llega desde tu perfil y aterriza en un menú de opciones tiene que adivinar otra vez. Qué va exactamente en esa página está en [qué poner en el link de la bio](/es/blog/que-poner-en-el-link-de-la-bio).
...
## El catálogo de WhatsApp sirve, hasta cierto punto
...
- Las variantes se vuelven incómodas. Tamaño, sabor y cantidad se convierten en productos separados muy rápido, y treinta fichas ya no son un menú.
- No hay total. El comprador no puede sumar el envío, aplicar tu pedido mínimo ni ver cuánto debe realmente.
- No captura la dirección. Sigues preguntando.
- Vive dentro de WhatsApp, así que no le sirve de nada a la persona que te encontró en Instagram y todavía no te escribe.
...
## Cómo hacer que el pedido llegue escrito

Un pedido necesita seis cosas y ninguna más.

1. **Qué.** El producto, con el nombre que usas en tus publicaciones.
2. **Opciones.** Sabor, tamaño, cantidad. Escritas.
3. **Dónde.** Dirección completa con la referencia que tu repartidor realmente usa.
4. **Cuándo.** La fecha. En comida esto no es opcional.
5. **Total.** Producto más envío, un solo número, en su propia línea.
...
## El mensaje de confirmación es el seguro más barato
...
## Costumbres que te cuestan la tarde
...
## Lo que WhatsApp no te va a dar
