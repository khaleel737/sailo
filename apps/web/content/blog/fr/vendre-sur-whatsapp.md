---
title: Vendre sur WhatsApp sans y passer ses soirées
description: "Transformer une conversation en commande qui a un total, une adresse et une date, tenir le coup du jeudi soir, et savoir qui confirme le paiement."
date: 2026-08-06
author: Sailo team
cover: /blog/covers/vendre-sur-whatsapp.svg
coverAlt: "Un téléphone posé sur un plan de travail avec une liste de commandes à côté"
tags: [whatsapp, commandes]
---
...
## Ce que WhatsApp fait très bien, et ce qu'il ne fait pas
...
## Vingt-deux messages pour une part à 12 €
...
## Le catalogue et la conversation ne font pas le même travail
...
C'est la même logique que le lien de votre profil Instagram, qui doit mener à quelque chose où l'on commande, pas à un menu en photo. Si vous ne savez pas encore quoi y mettre, [que mettre dans le lien bio](/fr/blog/que-mettre-dans-le-lien-bio) le détaille.

## Les quatre réponses rapides à enregistrer ce soir
...
**Le virement que vous n'avez pas encore vu.** « Merci, je regarde. Il n'apparaît pas encore sur mon compte, entre deux banques ça met parfois quelques heures. Dès que je le vois, je vous confirme. » C'est le message le plus délicat de la semaine et c'est celui qu'il ne faut surtout pas improviser à 23 h. La mécanique complète, avec le nom du titulaire à afficher et le seuil au-dessous duquel on ne discute pas, est dans [se faire payer par virement](/fr/blog/se-faire-payer-par-virement).
...
## Le jeudi soir, quand tout arrive en même temps
...
## Quand la commande change après l'emballage
...
Et si la modification passe, refaites le total en entier dans le message de confirmation. Ne dites jamais « ça fait 24 € de plus ». Dites « le nouveau total est de 76 €, dont 4 € de livraison ». Les erreurs de montant au moment du virement viennent presque toutes d'un total partiel envoyé en cours de route. Si la ligne de livraison n'est pas encore claire dans votre tête, [calculer ses frais de port](/fr/blog/calculer-les-frais-de-port) donne la méthode pour la poser une fois pour toutes.

## Votre numéro personnel, et ce qu'on peut honnêtement y faire
...
## Des horaires que vous tenez vraiment
...
Et si vous voulez que la commande arrive rédigée au lieu d'être reconstituée à la main, l'organisation complète, de la photo au paiement, est dans [vendre sur Instagram sans site](/fr/blog/vendre-sur-instagram-sans-site).
