---
title: Que mettre dans le lien bio quand la page doit vendre
description: "Que mettre dans le lien bio pour arrêter de répondre aux mêmes questions. Le prix, le port, la façon de commander, et ce qui n'a rien à faire là."
date: 2026-08-06
author: Sailo team
cover: /blog/covers/que-mettre-dans-le-lien-bio.svg
coverAlt: "Un écran de téléphone affichant une page boutique avec des prix visibles"
tags: [instagram, conversion]
---
...
## Une page de boutons, ou une page qui est la boutique
...
Une chose encore, et elle passe avant le texte : la première photo. Si elle est floue, mal cadrée ou d'une couleur qui ne correspond pas au tirage, aucune ligne de texte ne rattrape ça. [Photographier ses produits au téléphone](/fr/blog/photographier-ses-produits-au-telephone) explique comment obtenir une image nette au bord d'une fenêtre, sans matériel.

## « Tu es basée où ? » et « tu livres en Belgique ? »
...
## Le prix doit être sur la page, même quand ça pique
...
## Ce qu'il ne faut pas mettre là

Une liste courte, parce que chaque élément retiré est un appui gagné.

- Un lien vers votre newsletter au-dessus des produits. Elle a sa place, tout en bas.
- Un formulaire qui demande un e-mail avant de montrer quoi que ce soit.
- Un catalogue en PDF ou en document partagé. Ça se télécharge mal, ça ne se commande pas, et sur un téléphone c'est illisible.
- Une page « site en construction » avec une date. La date sera dépassée et vous ne la changerez pas.
- Cinq réseaux sociaux en haut de page. La personne est déjà sur un de vos réseaux, elle n'en cherche pas un deuxième.
- Un texte de présentation à la troisième personne. On sait que c'est vous.
...
## Un seul emplacement de lien, et une promo à faire passer
...
## Le lien de story qui envoie vers une affiche déjà partie
...
Et gardez une réponse rapide prête pour les messages qui suivront : « Celle-là est partie, il en reste deux du même format, je te montre ? » Vous en récupérez une partie. Le reste du système de messages, avec la commande qui arrive déjà rédigée, est dans [vendre sur WhatsApp](/fr/blog/vendre-sur-whatsapp).

## Les chiffres de Nadia
...
Si votre page est prête et que le problème est plutôt qu'il n'y a encore personne pour la voir, la suite est ailleurs : [obtenir ses premières commandes](/fr/blog/obtenir-ses-premieres-commandes) part de zéro abonné. Et pour remettre cette page à sa place dans le circuit complet, entre les stories et le virement qui arrive, [vendre sur Instagram sans site](/fr/blog/vendre-sur-instagram-sans-site) suit une commande du début à la fin.
