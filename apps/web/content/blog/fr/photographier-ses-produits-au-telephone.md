---
title: Photographier ses produits au téléphone quand on vend en ligne
description: "La lumière et le fond décident, pas le téléphone. Les heures qui marchent chez vous, la photo d'échelle, le défaut assumé et la séance d'Inès."
date: 2026-08-06
author: Sailo team
cover: /blog/covers/photographier-ses-produits-au-telephone.svg
coverAlt: "Une bague en argent posée sur une feuille blanche près d'une fenêtre, un téléphone au-dessus"
tags: [photo, produits]
---
...
## Ce n'est pas le téléphone, c'est la fenêtre
...
## Le plafonnier ment sur les couleurs
...
## Le fond, c'est ce qui fait boutique ou vide-grenier
...
## La photo qui vend n'est pas la plus jolie
...
## Photographier tout un lot en une fois
...
### La liste de prises, par pièce

1. La pièce seule, de face, centrée, fond blanc. C'est la photo de la fiche et de la vignette.
2. Trois quarts, légèrement en plongée. Celle qui donne le volume.
3. L'échelle : au doigt, ou à côté de la pièce de 2 €.
4. Le détail : la soudure, la texture, le poinçon.
5. La mise en situation : sur la main, dans sa pochette, à côté du carnet. Celle qui part dans le feed.

Cinq prises. Pas huit.

### Ce que coûte une séance de douze pièces
...
## Les réglages du téléphone qu'on change une seule fois

- Nettoyez l'objectif avec un chiffon, pas avec le tee-shirt. Une trace de doigt donne un voile blanchâtre sur toutes vos photos, et on ne le voit qu'en comparant avec une photo propre.
- Activez la grille dans les réglages photo. Elle sert à centrer et à garder l'horizontale.
- Appuyez longuement sur l'écran pour verrouiller la mise au point et l'exposition, puis glissez le doigt vers le bas pour assombrir un peu. Sur de l'argent, l'automatique surexpose presque toujours.
- Restez en mode photo normal. Le mode portrait floute les bords, et sur un bijou il mange précisément le détail que vous vouliez montrer.
- Flash éteint. Sur du métal, il fabrique un point blanc et une ombre noire derrière.
- Ne zoomez pas avec les doigts. Approchez le téléphone.
- Déclenchez avec le bouton de volume, ou avec le retardateur à 3 secondes. Le tremblement au moment du clic est la première cause de photos molles.
- Si votre téléphone applique un embellissement automatique par défaut, coupez-le. Il lisse les textures, et la texture est ce que vous vendez.

## Retoucher, oui. Filtrer, non.
...
## Une photo de feed et une photo de fiche ne font pas le même travail
...
## Combien de photos une fiche demande vraiment
...
Avant de refaire toutes vos photos, vérifiez quand même que vos prix tiennent debout, parce qu'une belle photo sur un prix trop bas ne fait qu'accélérer le problème : [fixer ses prix en artisanat](/fr/blog/fixer-ses-prix-artisanat) reprend le calcul poste par poste. Si le blocage n'est pas la photo mais le fait que personne ne commande, commencez plutôt par [obtenir ses premières commandes](/fr/blog/obtenir-ses-premieres-commandes). Et si vous n'avez encore aucune page où poser tout ça, l'ordre complet est dans [vendre sur Instagram sans site](/fr/blog/vendre-sur-instagram-sans-site).
