---
title: Se faire payer par virement quand on vend en ligne
description: "Quelles coordonnées donner, pourquoi une capture n'est pas un paiement, et le message exact quand on vous dit avoir viré et que vous ne voyez rien."
date: 2026-08-06
author: Sailo team
cover: /blog/covers/se-faire-payer-par-virement.svg
coverAlt: "Une fiche de commande posée à côté d'un relevé bancaire avec une ligne au crédit surlignée"
tags: [paiements, virement]
---
...
## Les trois lignes à donner, et celle que presque personne n'écrit
...
- **L'IBAN**, entier. FR76 et la suite. Avec ou sans espaces, peu importe, mais entier.
- **Le BIC**, parce que certaines banques le demandent encore au moment d'ajouter un bénéficiaire, et parce que l'acheteur qui ne le trouve pas vous écrit au lieu de payer.
- **Le nom exact du titulaire du compte.** Celui qui apparaît sur le relevé, pas le nom de votre boutique.
...
## Une capture d'écran n'est pas un paiement
...
## Instantané ou classique, et pourquoi il ne faut pas deviner
...
## Le libellé, qui ne marche qu'à moitié
...
## Quand le montant arrive en dessous
...
La vraie correction est en amont : si le total affiché comprend déjà la livraison, l'acheteur ne fait plus l'addition de tête à 22 h. Et si vous ne savez pas encore quoi mettre dans cette ligne de livraison, la méthode de calcul est dans [calculer ses frais de port sans y perdre sa marge](/fr/blog/calculer-les-frais-de-port).

## Ce qu'on répond quand on vous dit « je t'ai fait le virement »
...
Si vos échanges se passent surtout dans une messagerie, ces réponses enregistrées valent encore plus cher, et la mécanique complète est dans [vendre sur WhatsApp sans y passer ses soirées](/fr/blog/vendre-sur-whatsapp).

## L'acheteur qui propose Lydia ou Paylib
...
## Quand le virement cesse de vous suffire
...
Si vous voulez en plus que la commande arrive avec le total déjà additionné, l'organisation complète est dans [vendre sur Instagram sans site](/fr/blog/vendre-sur-instagram-sans-site). Et si vous cherchez encore à qui vendre, commencez par [obtenir ses premières commandes](/fr/blog/obtenir-ses-premieres-commandes), parce qu'un encaissement parfaitement réglé sans acheteur n'encaisse rien du tout.
