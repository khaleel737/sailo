---
title: Obtenir ses premières commandes en ligne quand personne ne vous connaît
description: "Les dix premières commandes ne viennent presque jamais d'inconnus. D'où elles arrivent vraiment, le message qui marche, et le rythme semaine après semaine."
date: 2026-08-06
author: Sailo team
cover: /blog/covers/obtenir-ses-premieres-commandes.svg
coverAlt: "Un carnet ouvert avec une liste de prénoms cochés à côté d'un téléphone"
tags: [ventes, débuts]
---
...
## Les huit premières semaines de Thomas, sans arrondir
...
## Le message qui marche ne contient pas votre lien
...
1. Un prénom, et une raison d'écrire à cette personne-là. Si la raison n'existe pas, n'envoyez pas le message, ajoutez la personne à la liste de la semaine prochaine.
2. Une seule proposition. Pas votre catalogue.
3. Une question fermée à la fin. « Je t'en garde un ? » se répond en un mot. « Dis-moi ce qui te tente ! » ne se répond pas du tout.
...
## Publier plus n'est pas la réponse à 40 abonnés
...
## Vos dix premières commandes sont une étude, pas un chiffre d'affaires
...
Si la question qui revient chez vous est « il fait quelle taille ? » ou « c'est quelle couleur en vrai ? », ce n'est pas une question, c'est une photo qui manque. [Photographier ses produits au téléphone](/fr/blog/photographier-ses-produits-au-telephone) détaille les prises de vue qui suppriment ces messages, et celle qui compte le plus est la photo d'échelle, celle que presque personne ne prend.

Si la question qui revient est « tu livres où ? » ou « c'est combien la livraison ? », c'est une ligne qui manque sur votre page d'accueil. [Que mettre dans le lien bio](/fr/blog/que-mettre-dans-le-lien-bio) passe en revue ce qu'un acheteur doit pouvoir lire avant de faire défiler.

## Le jour où un inconnu commande
...
## La deuxième commande vaut plus que la première
...
Si vos échanges se passent déjà en messagerie, [vendre sur WhatsApp](/fr/blog/vendre-sur-whatsapp) contient les réponses rapides à enregistrer une fois pour toutes, dont celle-là.

## Comptez autre chose que vos abonnés
...
- **Conversations démarrées cette semaine.** Pas les vues. Les échanges où vous et quelqu'un d'autre avez écrit au moins une fois chacun.
- **Personnes qui ont vu le produit en vrai.** Marché, boutique, main d'un ami. C'est le meilleur prédicteur de commande qui existe pour un produit physique.
- **Deuxièmes commandes.** Le jour où ce chiffre dépasse zéro, votre produit tient. Tant qu'il est à zéro avec vingt clients, quelque chose ne va pas et ce n'est pas votre visibilité.

## Ce qui est normal, et quand arrêter
...
## Ce que Sailo change ici, et ce qu'il ne change pas
...
Ce que la boutique apporte à ce moment-là est très concret : une page où le prix, les options et la livraison sont écrits, et une commande qui arrive complète, avec l'article, les options, l'adresse et le total déjà calculé, au lieu d'une conversation à reconstituer. La commande peut arriver par WhatsApp, par Instagram, par Telegram, par e-mail ou par téléphone, et sur ces canaux Sailo ne touche jamais l'argent et ne prend aucune commission. Le virement non plus. La seule commission qui existe est de {{fee_range}} % sur la valeur des produits quand le paiement se fait par carte, et la carte demande la formule Business à {{business_monthly}} $ par mois avec un compte Stripe validé. Stripe est disponible en France au 6 août 2026, donc ce paiement par carte fonctionne réellement ici, mais revérifiez à la date où vous lisez ces lignes.

La limitation qui compte vraiment pour vous, à ce stade : **la formule gratuite conserve {{free_analytics_days}} jours de statistiques.** C'est plus court que le temps qu'il faut à la plupart des gens pour atteindre dix commandes. Autrement dit, en mai vous ne pourrez plus comparer avec mars. Soit vous tenez votre propre carnet, ce que Thomas a fait et ce que je vous conseille de faire de toute façon, soit vous passez à Pro à {{pro_monthly}} $ par mois pour un an d'historique. La formule gratuite s'arrête aussi à {{free_products}} produits, ce qui est confortable au début et serré dès que vous avez trois formats et deux origines.
...
Quand vous en serez à organiser tout ça pour de bon, [vendre sur Instagram sans site](/fr/blog/vendre-sur-instagram-sans-site) reprend l'ordre complet, de la découverte dans le fil jusqu'au paiement, et dit où chaque étape doit se passer.
