---
title: Website olmadan Instagram'dan satış yapmak
description: Instagram müşteriyi getiriyor ama fiyat vermiyor, adres tutmuyor ve para tahsil etmiyor. Bu üç işin nereye düştüğünü gerçek rakamlarla anlatıyoruz.
date: 2026-08-06
author: Sailo team
cover: /blog/covers/website-olmadan-instagramdan-satis.svg
coverAlt: Fiyatları görünen bir katalog ızgarası ve yanında yazılı gelmiş bir sipariş
tags: [instagram, satış]
---
...
## Bir satışın üç parçası var, Instagram bunlardan birini yapıyor
...
## "Fiyat DM'den" artık para kaybettiriyor
...
## Biyografi linki bir menü değil, dükkânın kendisi olmalı
...
1. **Ne.** Ürünün adı, gönderilerinde kullandığın adla aynı.
2. **Seçenekler.** Renk, beden, adet, koku. Yazılı, varsayılmış değil.
3. **Nerede.** Açık adres, ve kuryenin gerçekten kullandığı tarif.
4. **Ne zaman.** Tarih önemliyse. Yemekte ve hediyede sandığından çok daha önemli.
5. **Toplam.** Ürün artı kargo, tek bir sayı, kendi satırında.
6. **Nasıl ödeyecek.** Havale, kapıda ödeme, kart.
...
### Hangi siparişte hangi yöntemi öneriyorsun
...
## Kargo, marjın sessizce öldüğü yer
...
En çok satan beş ürününü düzgün çek, gerisini sonra. Telefon ayarları, hangi lensin kullanılacağı ve doygunluğu artırmanın neden iade olarak geri döndüğü [telefonla ürün fotoğrafı çekmek](/tr/blog/telefonla-urun-fotografi-cekmek) yazısında.

## Rakiplerin bunu altı yıldır yapıyor
...
- Mesaja dakikalar içinde dönüş, ve dönemeyeceği saatlerin yazılı olması.
- Sayfada yazan bir kargo süresi, ve o sürenin tutulması. Üç gün yazıp beş günde göndermek, hiç yazmamaktan kötü.
- Kapıda ödeme sorusunun cevabının sayfada durması, DM'de değil.
- Sayfada duran gerçek değerlendirmeler. Sailo'da her planda var: alıcı adını, 1 ile 5 arası yıldızını ve isterse yorumunu bırakıyor, ve sen onaylayana kadar hiçbiri görünmüyor. Onay senin elinde olduğu için ilk yorumu almak da senin işin, kimse getirmiyor.
- İade sorulduğunda tartışmadan verilen bir cevap. Mesafeli satışta alıcının hakları mevzuatla belirli, o yüzden kendi metnini yazmadan önce Ticaret Bakanlığı'nın tüketici sayfalarına bak ya da bir mali müşavire sor. Vergi tarafı için de aynısı geçerli, gib.gov.tr ve müşavirin.
...
Çoğu satıcı için doğru cevap "ikisi birden" oluyor. Pazaryeri hacim getiriyor, kendi sayfan ise ilişkiyi ve marjı tutuyor. Ama hiç trafiğin yoksa katalogdan başlama, [ilk siparişlerini almak](/tr/blog/ilk-siparislerini-almak) yazısından başla. Ziyaretçisi olmayan mükemmel bir dükkân, dükkân değil.
...
Ücretsiz plan {{free_products}} üründe ve {{free_analytics_days}} günlük istatistikte duruyor. Yeni başlayan çoğu kişiye fazlasıyla yeter, ama beden ve rengi ayrı ürün olarak açıyorsan 20 bir haftada bitiyor. Pro {{pro_monthly}} USD/ay veya {{pro_yearly}} USD/yıl, {{pro_products}} ürüne ve bir yıllık istatistiğe çıkıyor, Sailo rozetini kaldırıyor, CSV dışa aktarma veriyor. Kart onda da yok, kart sadece Business'ta. Ve Business parası tek başına kart düğmesini garanti etmiyor, çünkü kartın açılması Stripe'ın senin ülkenden hesap kabul etmesine bağlı. Onu da stripe.com/global sayfasından kendin kontrol ediyorsun.
