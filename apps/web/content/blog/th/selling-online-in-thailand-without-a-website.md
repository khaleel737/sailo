...
เรื่องราคา แผนฟรีคือ 0 ดอลลาร์ ลงสินค้าได้ {{free_products}} ชิ้น ดูสถิติย้อนหลัง {{free_analytics_days}} วัน ใช้ช่องทางแชทและช่องทางจ่ายเงินแบบแมนนวลได้ทั้งหมด แต่ไม่มีปุ่มบัตร แผน Pro อยู่ที่ {{pro_monthly}} ดอลลาร์ต่อเดือน หรือ {{pro_yearly}} ดอลลาร์ต่อปี ได้ {{pro_products}} สินค้า สถิติย้อนหลังหนึ่งปี ไม่มีตรา Sailo บนหน้าร้าน และส่งออกข้อมูลเป็น CSV ได้ แผน Business อยู่ที่ {{business_monthly}} ดอลลาร์ต่อเดือน หรือ {{business_yearly}} ดอลลาร์ต่อปี ลงสินค้าได้ไม่จำกัด สถิติสามปี มีคูปอง มีระบบแนะนำต่อ และมีปุ่มบัตร
