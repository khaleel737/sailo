...
เรื่องปุ่มบัตร เราเปิดดู stripe.com/global เมื่อวันที่ 6 สิงหาคม 2026 แล้วไม่พบประเทศไทยในรายชื่อที่รองรับ ปุ่มบัตรของ Sailo วิ่งบน Stripe อย่างเดียว และต้องใช้แผน Business ที่ {{business_monthly}} ดอลลาร์ต่อเดือน แปลว่าปุ่มบัตรอาจเปิดใช้ไม่ได้ไม่ว่าจ่ายเท่าไหร่ รายชื่อนั้นเปลี่ยนได้ ให้เช็คเองที่ stripe.com/global ก่อนจ่ายค่าแผน สำหรับลูกค้าไทยที่ซื้อของหลักร้อย เรื่องนี้แทบไม่กระทบ เพราะเขาไม่ได้รอปุ่มบัตรอยู่แต่แรก
