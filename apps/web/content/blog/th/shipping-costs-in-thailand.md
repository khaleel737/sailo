...
ค่าธรรมเนียมของ Sailo มีที่เดียวคือช่องทางบัตร คิด {{fee_range}}% ของค่าสินค้าหลังหักส่วนลด ไม่รวมค่าส่งและภาษี แปลว่าบรรทัดค่าส่งไม่เคยโดน {{fee_range}}% นั้นเลย ส่วนออเดอร์ที่มาทางโอนหรือปลายทาง Sailo ไม่เก็บอะไรทั้งสิ้น เพราะไม่ได้แตะเงินก้อนนั้น ปุ่มบัตรต้องใช้แผน Business ที่ {{business_monthly}} ดอลลาร์ต่อเดือน หรือ {{business_yearly}} ดอลลาร์ต่อปี และต้องมีบัญชี Stripe ที่ผ่านการอนุมัติ
