...
ถ้าคุณใช้ Sailo แผนฟรี คุณลงสินค้าได้ {{free_products}} ชิ้น จบแค่นั้น

แปลว่าการนั่งถ่ายของหกสิบชิ้นในสัปดาห์แรกไม่ใช่แค่เหนื่อยเปล่า มันคืองานที่คุณยังเอาขึ้นหน้าร้านไม่ได้ด้วยซ้ำ

ทางที่ควรทำคือถ่าย 12 ถึง {{free_products}} ชิ้นที่คุณเดาว่าขายออกที่สุดก่อน ลงให้ครบ ปล่อยไว้สองถึงสามสัปดาห์ ดูว่าชิ้นไหนมีคนกดดูและมีคนทัก แล้วค่อยตัดสินใจว่าจะถ่ายอะไรเพิ่ม ถ้าถึงจุดที่ {{free_products}} ชิ้นไม่พอจริง ๆ แผน Pro อยู่ที่ {{pro_monthly}} ดอลลาร์ต่อเดือน หรือ {{pro_yearly}} ดอลลาร์ต่อปี ลงได้ {{pro_products}} ชิ้น ดูสถิติย้อนหลังได้หนึ่งปี ไม่มีตรา Sailo บนหน้าร้าน และส่งออกข้อมูลเป็น CSV ได้
