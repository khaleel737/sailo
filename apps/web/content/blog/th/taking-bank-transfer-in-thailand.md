...
ข้อดีของการที่ Sailo ไม่แตะเงินก้อนนี้เลยคือมันไม่หักอะไรเลย ออเดอร์ที่มาทางโอน ปลายทาง แชท อีเมล หรือโทรศัพท์ Sailo ไม่เก็บค่าธรรมเนียม เพราะเงินไม่เคยผ่านมือ Sailo ตั้งแต่แรก ที่เดียวที่มีค่าธรรมเนียมคือช่องทางบัตร คิด {{fee_range}}% ของค่าสินค้าหลังหักส่วนลด ไม่รวมค่าส่งและภาษี เก็บผ่าน Stripe และเงินเข้าบัญชี Stripe ของคุณเอง

### เรื่องปุ่มบัตรกับประเทศไทย

ปุ่มบัตรของ Sailo ต้องใช้แผน Business ที่ {{business_monthly}} ดอลลาร์ต่อเดือน หรือ {{business_yearly}} ดอลลาร์ต่อปี และต้องมีบัญชี Stripe ที่ Stripe อนุมัติให้รับชำระเงินได้
...
แผนฟรีที่ 0 ดอลลาร์ลงสินค้าได้ {{free_products}} ชิ้น ดูสถิติย้อนหลัง {{free_analytics_days}} วัน และใช้ช่องทางโอนกับปลายทางได้ครบ ถ้าคุณขายกาแฟสี่แบบ นั่นเหลือเฟือ ถ้าคุณขายเสื้อผ้ามือสองที่แต่ละตัวเป็นคนละสินค้า ยี่สิบชิ้นหมดภายในสัปดาห์เดียว
