---
title: How to run a discount without losing money
description: A discount comes out of your margin, not your price. Work out how many extra units it makes you sell before you announce it, because the number is brutal.
date: 2026-08-06
author: Sailo team
cover: /blog/covers/how-to-run-a-discount-without-losing-money.svg
...
## Work out the real margin first, because yours is probably fiction
...
- Materials, including the bits you don't count. Thread, tape, labels, the poly bag, the tissue paper.
- Anything you outsource. Printing, tailoring, roasting, cutting.
- Wastage. If one in eight prints comes out wrong, your cost per good print is your cost divided by 0.875.
- Packaging that gets it there intact.
- Payment costs, if any.
- **Your own time, at a number.** Any number. ₹200 an hour, £12 an hour, whatever you'd accept from someone else.
...
## What Meera's Diwali sale actually cost her
...
Notice what's not on that list: because sales are slow. A discount will not fix low demand, and if you're at zero sales the reason is almost never price. [What to do when nobody is buying](/en/blog/what-to-do-when-nobody-is-buying) works through the six things it's more likely to be, in order of how cheap they are to check.

## Discounts that cost less than a percentage off
...
## Don't raise the price so you can discount it
...
## Time-box it, or it becomes your price
...
- Put an end date on it and honour it. If it ends Sunday, it ends Sunday.
- Don't run one more than three or four times a year.
- Never discount your best seller. It sells anyway. Discount the thing that doesn't.
- Don't stack. One offer at a time, or you'll wake up having sold something at 45% off you meant to sell at 20%.
- Say what the discount is for. "Clearing the last of the indigo run before the new batch" is credible. "Mega sale" trains people to wait.

And if you find yourself running a sale every month to hit your number, the problem isn't the discount, it's the price. [When to raise your prices](/en/blog/when-to-raise-your-prices) is a more useful conversation than another markdown.

## The small costs that come out after the discount
...
**Payment costs.** Whatever your card processor charges is on the discounted total, which is fine, but it's a fixed-plus-percentage structure on most rails, so the fixed part becomes a bigger share of a smaller order. A flat fee that was 2% of a ₹1,450 order is 2.5% of a ₹1,160 one. On small baskets this gets ugly fast, and [how payment fees eat a small order](/en/blog/how-payment-fees-eat-a-small-order) has the detail.
...
## Before your next sale, do three sums

Not a strategy. Three numbers on paper, in about fifteen minutes.

1. **Your real cost per unit,** with your own hours in it at a number you'd accept from someone else.
2. **Your margin as a percentage** of your selling price. Cost divided by price, subtracted from one.
3. **Your break-even multiplier** from the table, or from margin ÷ (margin - discount).
...
And when the sale is over, check where the buyers came from. If most of them were people already on your list, you didn't run a promotion, you ran a rebate, and the same effort spent on [getting your first ten orders](/en/blog/getting-your-first-ten-orders) from people who've never bought from you would have been worth more at full price.
