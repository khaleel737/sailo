---
title: Selling to a group chat
description: Group orders move fast and collapse quietly. How to run a round with a close time, keep the list outside the chat, and stay welcome in the group.
date: 2026-08-06
author: Sailo team
cover: /blog/covers/selling-to-a-group-chat.svg
coverAlt: A phone showing a conversation thread
tags: [whatsapp, groups, nigeria]
---
...
## A group is a sales floor with no counter
...
So the group is the shop floor. The list has to live somewhere else. That's the whole architecture, and it's the same split described in [selling on social media without a website](/en/blog/selling-on-social-media-without-a-website): the crowd is in one place, the record is in another.

## Three kinds of group, and the rules differ in each
...
## The etiquette that keeps you in the group

This isn't manners for their own sake. Every one of these has a direct commercial reason.

- **Ask the admin first.** One private message: "Is it okay if I post my rate list on Saturdays?" Costs you nothing, and it converts you from an intruder into someone with permission. It also gives you an ally when someone complains.
- **One post per round, not per product.** Three posts in a morning is how a group starts muting you. Put everything in one message with one photo grid.
- **Never reply to a price question inside the group.** Every reply notifies everyone, and the fastest way to get removed is to be the reason people mute the group. Reply privately, always, even when the question was public.
- **Don't DM people who haven't messaged you.** Lifting numbers out of a group and cold-messaging them is the single most complained-about behaviour in Nigerian community groups. You get one report and you're out.
- **Post the delivery day at the same time as the price.** People plan around it and it prevents the "when am I getting mine" pile-up.
- **Say thank you in the group after delivery, once.** Publicly acknowledging the people who paid is free social proof and it makes the next round easier.
...
## Rounds, and why an open-ended sale collapses
...
- Editing a message on a phone while ten more arrive is genuinely difficult.
- People reply to old versions of the pinned message, so you get orders against prices that have changed.
- WhatsApp lets you pin one message prominently. Your list competes with whatever the group is actually talking about.
- If you delete the wrong thing, the list is gone and there's no history.
...
The screenshot problem lives here too. Somebody will send you a transfer receipt image and you will feel obliged to ship on the strength of it. Don't. A receipt image is a claim, not a payment, and there are enough edited ones in circulation to make it a bad basis for handing over ₦28,000 of stock. Open your own bank app and look. The process for doing that without insulting genuine customers is in [how to know a bank transfer actually arrived](/en/blog/how-to-know-a-bank-transfer-actually-arrived).

## When the price moves mid-round
...
- **Absorb it.** Costs you ₦27,600 on that round. Sometimes correct, once, for a group you want to keep.
- **Go back and ask for the difference.** Kills trust. People remember this for a long time and some will simply refuse.
- **Price the round so it doesn't happen.** Build a buffer in, state the price as fixed for that round only, and close the round quickly enough that the market can't move under you.
...
1. **Saturday 8am.** One post. Photo, price, "closes 2pm", delivery Sunday between 4 and 7pm, and a link. Nothing else.
2. **Every reply is private.** Public questions get a private answer and a link.
3. **The list lives on the page.** People order there, with their flat number, so she isn't extracting addresses from messages.
4. **2pm.** She posts "Closed. 26 kegs." Nothing more.
5. **2pm to 6pm.** Payment window. Bank details are in the post and on the checkout page. She checks her app, not the screenshots.
6. **Sunday afternoon.** One trip, one block at a time, in the order the list is in.
...
The broader picture for running this kind of business here, including registration and what buyers expect, is in [selling online in Nigeria](/en/blog/selling-online-in-nigeria).

## Group, broadcast list, or channel
...
**A WhatsApp Channel** is one-way. You post, followers read, nobody replies. Good for announcements at scale, useless for the back-and-forth that a bulk round needs. There's a full treatment of where those fit in [using WhatsApp channels to sell](/en/blog/using-whatsapp-channels-to-sell).

The combination that works for most sellers running rounds: post the round in the group where the community effect lives, take the orders on a page, and confirm each one in a one-to-one chat. The mechanics of making that last part arrive already written are in [how to take orders on WhatsApp](/en/blog/how-to-take-orders-on-whatsapp).

## What Sailo can't do inside your group
...
On money, be clear about the limits. Bank transfer is a real payment rail, and Sailo takes no commission on it, because Sailo never touches the money. It also can't see your account, so it can't tell you a ₦28,000 transfer landed. Only your bank app can. If you take Opay or PalmPay or Moniepoint transfers, those are bank transfers as far as this works, and your details go in the bank transfer fields. Card payments are a different story: they need the Business plan at ${{business_monthly}} a month plus a Stripe account cleared for charges, and Sailo takes {{fee_range}}% of the goods on each card order.

One more thing sellers ask about specifically for groups. A discount code for group members is a coupon, and coupons are on the Business plan only. At ${{business_monthly}} a month, for a round doing 26 kegs once a week, that's a real cost to weigh against just posting a group price in the message and honouring it.

## Run one round properly and count two numbers

Don't redesign your whole operation. Run a single round the strict way.

1. Message the admin and ask permission, even if you think you have it.
2. Write the post before Saturday. Item, price, close time, delivery window, link. One photo grid.
3. Post once. Answer everything privately.
4. Close on time and post the closed count in the group.
5. Check your bank app, not the screenshots, and mark the list as you go.
6. Deliver in one trip, in list order.
