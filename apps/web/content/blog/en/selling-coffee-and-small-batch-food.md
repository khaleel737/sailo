---
title: Selling small batch food online
description: Roast dates, weekly cycles and freshness windows. How small batch makers turn a spoilage problem into a scheduling problem, and what shipping food costs.
date: 2026-08-06
author: Sailo team
cover: /blog/covers/selling-coffee-and-small-batch-food.svg
coverAlt: A circle with a thin wedge marked out of it
tags: [coffee, food, niches]
---
...
## Put the date on the bag, and make it the make date
...
## The weekly cycle is the whole operating system
...
## Roast loss, batch size and the money that evaporates
...
- **Bag with a one-way valve:** roughly $0.35 to $0.60 each in small quantities.
- **Label:** around $0.10 to $0.15 if you print your own, more if they're done properly.
- **Shipping box and filler:** $1.00 to $1.50.
- **Postage:** whatever your carrier actually charges, which is more than you think for a two-bag order.
...
## Shipping perishables without a cold chain you can't afford
...
- **Insulate what needs it.** A foil liner and a gel pack costs somewhere around $3 to $5 and is the difference between chocolate and a puddle in July. Charge for it as a summer surcharge rather than absorbing it silently.
- **Overnight or two-day for anything genuinely perishable.** Which usually means the shipping costs more than the product, which usually means the product should be sold locally instead. That's a real conclusion and plenty of makers reach it.
- **Bags with valves need to breathe, boxes need to not crush.** A 12oz bag of coffee survives almost anything. A jar of sauce with a loose lid is a claim waiting to happen.
- **Photograph the parcel before it goes**, once, for your own records, if you're shipping anything glass.

The general packing principles that survive a sorting facility, including what actually protects a corner and what only looks like it does, are in [packaging that survives the courier](/en/blog/packaging-that-survives-the-courier).
...
## The rules question, and the one category that's different
...
The same principle applies to any home food business, and the food-safety line between things that need refrigeration and things that don't is worked through from the baking side in [how to start selling baked goods](/en/blog/how-to-start-selling-baked-goods).

## Subscriptions, and the honest version
...
He also stopped shipping on Thursdays after a summer weekend where four orders sat in a facility until Monday. Photographing the bags well enough that people order in the first place is its own skill, and the one-window method for food is in [what to photograph when you sell food](/en/blog/what-to-photograph-when-you-sell-food).
