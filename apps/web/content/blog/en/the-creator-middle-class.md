---
title: The creator middle class nobody posts about
description: "Making a living as a small creator is arithmetic, not fame. Here is what a real £2,600 month contains, line by line, hour by hour, after costs."
date: 2026-08-06
author: Sailo team
cover: /blog/covers/the-creator-middle-class.svg
...
## Nobody screenshots a normal month
...
## Start from the bill, not the follower count
...
## The middle class runs a stack, not a product
...
1. **Something that pays well and takes your time.** Services, commissions, teaching. This is the load-bearing wall in year one.
2. **Something physical or fixed-price you can batch.** Made in a block, sold over weeks.
3. **Something digital that sells while you're asleep.** Small money, no marginal cost, and it compounds slowly.
4. **Something someone else pays for.** A brand fee, a commission, a licensing cheque. Lumpy and unreliable, and worth having anyway.
...
## Worked example: Hannah, Sheffield
...
The fix is a reference format, decided before you need it. Hannah asks for `HAN-` plus a first name in the transfer reference. It works about 80% of the time, which is enough to make the other 20% a five-minute job rather than a forty-minute one. [How to know a bank transfer actually arrived](/en/blog/how-to-know-a-bank-transfer-actually-arrived) covers the whole method, and it's the single most useful hour you can spend before your volume goes up.
...
## Gross is a story you tell strangers
...
Get in the habit of quoting the third number to yourself even while quoting the first to everyone else. [Working out if you are actually profitable](/en/blog/working-out-if-you-are-actually-profitable) has the arithmetic, including the part where you fix what leaves the business account each month instead of spending whatever happens to be sitting in it.

## Where the card fee question actually lands

At Hannah's volume the card decision is genuinely close, and it's worth doing the sum rather than assuming.

Sailo takes 0.5% of the goods on card payments, calculated after any discount and excluding delivery and tax. On her £28 kit that's 14p, plus whatever Stripe charges her, which depends on the card and the country. Fourteen pence is nothing.

The subscription isn't nothing. Card payments need Sailo's Business plan at $19.99 a month, and a Stripe account that Stripe has actually cleared for charges. If 26 kit buyers a month use a card, you're paying roughly $20 for the convenience of not chasing 26 transfers. That's about 75 cents an order, and against 45 minutes a day of reconciliation it's obviously worth it.
...
## Three things that keep people out of the middle
