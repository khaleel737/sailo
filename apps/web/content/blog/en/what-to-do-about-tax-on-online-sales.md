---
title: What to do about tax on online sales
description: You are taxed on profit, not on what lands in your account. What that means for a UK seller, what counts as a cost, and what to look up rather than guess.
date: 2026-08-06
author: Sailo team
cover: /blog/covers/what-to-do-about-tax-on-online-sales.svg
...
**VAT.** Triggered by turnover, not profit, and at a level most small sellers are nowhere near. It's a completely different regime, it changes how you price and invoice, and it arrives with an obligation to charge your customers something you weren't charging them last month. [VAT and invoicing anxiety](/en/blog/vat-and-invoicing-anxiety) covers the shape of it and the reason it frightens people more than it should.
...
## Profit means after costs, and the costs are bigger than you think
...
- **Packaging.** Boxes, mailers, tissue, tape, void fill, thank-you cards, the labels for the labels.
- **Postage you didn't charge for.** If shipping cost you £3.29 and you charged £2.95, the difference is a cost.
- **Payment fees.** Card reader fees, gateway percentages, the fixed pence per transaction. Read the total off your statements rather than estimating from a rate.
- **Subscriptions.** The shop plan, the design tool, the scheduling app, the domain, the cloud storage full of product photos.
- **Market and fair fees**, including the ones paid in cash to a man with a clipboard.
- **Travel to buy stock or work a market.** Most countries allow a per-mile or per-kilometre business travel figure; find your country's current rate and keep a log of the journeys, because a rate without a log is worth nothing.
- **A part of your phone and your internet**, apportioned honestly. If a quarter of your phone use is the shop, a quarter of the bill is a cost. Write down how you arrived at the fraction.
- **Equipment**, which is often treated differently from consumables because it lasts more than a year. How you claim for a £180 wax melter versus a £24 pack of wicks is a real distinction with real rules, and it's one worth asking about specifically.
- **Samples and giveaways**, including the free candle you posted to someone with an audience.

None of that is aggressive. It's just recording what the business actually cost to run, which is exactly what a set of books is for. If yours are patchy, [keeping records when you hate paperwork](/en/blog/keeping-records-when-you-hate-paperwork) is the ten-minutes-a-week version that makes this section usable rather than theoretical.

## Sophie, candles, Bristol
...
The second account is not optional here, and it doesn't need to be a business account. [Separating business and personal money](/en/blog/separating-business-and-personal-money) covers why one account is the most expensive habit in small retail, and how to fix it this afternoon without registering anything.

## Which year does a sale belong to
...
## The platforms are no longer quiet
...
If you're still unsure whether what you're doing counts as trading at all, that's the prior question and it has a proper test. [When a side hustle becomes a business](/en/blog/when-a-side-hustle-becomes-a-business) works through the indicators, and selling your own old possessions genuinely is different from buying things to resell.

## What this article can't tell you, and why
...
## Where Sailo sits, and where it doesn't
...
If you haven't sorted out whether you need to register anything at all, [do you need to register your business](/en/blog/do-you-need-to-register-your-business) is the piece that sits above this one.
