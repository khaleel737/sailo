---
title: Keeping records when you hate paperwork
description: Bookkeeping for a small online shop is four columns and ten minutes a week. Here is the smallest system that survives a tax return and a bad month.
date: 2026-08-06
author: Sailo team
cover: /blog/covers/keeping-records-when-you-hate-paperwork.svg
coverAlt: An invoice with the total set apart at the bottom
tags: [admin, bookkeeping]
---
...
## The reason the shoebox fails is arithmetic, not willpower
...
## What your records have to be able to answer
...
## One row per thing, and the row looks like this
...
## Receipts: capture at the counter, sort never
...
How long you have to keep any of this varies by country and by document type, and it's longer than most people assume. [What receipts to keep and for how long](/en/blog/what-receipts-to-keep-and-for-how-long) goes through it properly. Look up your own country's period rather than guessing, because "I thought it was three years" is not an answer anyone accepts.

## Ten minutes, same slot, every week
...
1. Open the bank app and the sheet side by side.
2. Every line in the bank that isn't in the sheet, add it.
3. Every line in the sheet marked Bank that isn't in the bank, chase it. Usually that's a customer who said they'd transfer and didn't.
4. Empty the receipts folder into the sheet.
5. Count the cash tin and write the number down.
...
## Marcus, screen prints, Baltimore
...
## When you're already six months behind
...
## Don't buy software in month one
...
They're where your tax return comes from, and reporting profit rather than turnover is the whole game. [What to do about tax on online sales](/en/blog/what-to-do-about-tax-on-online-sales) covers the shape of that, and the reason people overpay is almost always unrecorded expenses rather than anything clever they missed.

They're how you find out whether the shop actually makes money once packaging, fees and your own hours are counted. [Working out if you are actually profitable](/en/blog/working-out-if-you-are-actually-profitable) runs the full arithmetic on one basket, and it needs numbers you can only get from a ledger.

And they're only workable if the shop's money isn't tangled with your own. [Separating business and personal money](/en/blog/separating-business-and-personal-money) is the prerequisite, honestly, and doing it first makes everything above take half as long.

If you're not sure yet whether any of this applies to you, [do you need to register your business](/en/blog/do-you-need-to-register-your-business) sorts out which obligations you're actually under.
