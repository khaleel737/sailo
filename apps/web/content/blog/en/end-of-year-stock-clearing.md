---
title: End of year stock clearing
description: What you paid for dead stock is gone either way. The arithmetic of holding it versus discounting it, and a markdown ladder with dates attached.
date: 2026-08-06
author: Sailo team
cover: /blog/covers/end-of-year-stock-clearing.svg
...
## Sunk cost, said properly

The number you paid is irrelevant to the decision. That's uncomfortable and it's also just true.

What matters is:

1. **What you can realise for it now**, honestly, not what you hope.
2. **What it costs you to hold it** for another year.
3. **What it'll be worth in a year**, which for most categories is less.
4. **What the space and attention are worth** if the stock weren't there.
...
## Work out your own carrying cost
...
## The number that tells you it's dead
...
- Sold 3 in the last 6 months, so 0.5 a month. 11 in stock. That's **22 months of cover.**
- Sold 8 last month, 4 in stock. That's **0.5 months of cover**, and you should be reordering, not discounting.
...
Reading your own numbers properly rather than by feel is a habit worth building beyond this one exercise, and it's covered in [how to read your own numbers](/en/blog/how-to-read-your-own-numbers).

## The markdown ladder, with dates attached
...
Rung three is the other one worth dwelling on. A bundle moves the unit without teaching anyone that your prices drop, which matters if you'll sell the same line again next year. The general arithmetic on what a discount actually costs is in [how to run a discount without losing money](/en/blog/how-to-run-a-discount-without-losing-money), and it's worth reading before you set rung four's number.

## Existing buyers first, always
...
Do this by whatever channel you already own: a broadcast list, a WhatsApp group, an email list, or just forty individual messages, which is a fine use of an evening. If most of your relationships live in DMs, [how to get repeat buyers](/en/blog/how-to-get-repeat-buyers) covers the follow-up habit that makes this list worth having in the first place.

## Worked example: Sam, screen-printed tees, Denver
...
1. **Ten days at 20%, to past buyers only.** Moved 9.
2. **Ten days at 20% public.** Moved 4.
3. **Bundled with his best-selling design**, two tees for $46. Moved 11.
4. **Free with any order over $60** for the rest of December. Moved 14, and pushed roughly 20 orders from around $34 up over the threshold, which was worth more than the shirts.
5. **The last 5** went to a local run club as a giveaway, and two of those people ordered later.
...
## Do it before you buy for next year, not after
...
If a whole line went dead because the thing it was riding stopped being interesting, that's a slightly different problem with its own answer, and it's in [when a trend dies mid-order](/en/blog/when-a-trend-dies-mid-order).

## Two things to check before you write anything off
...
## Do this in the last week of November
...
And when the cupboard is clear, work out what you'd have bought instead with that money, because that's the real lesson and it's the one that changes next year's buying. If next year's plan is what you're actually thinking about, [planning a year of drops](/en/blog/planning-a-year-of-drops) is where to start.
