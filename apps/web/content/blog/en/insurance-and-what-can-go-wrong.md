---
title: Insurance, and what can actually go wrong
description: Most of what goes wrong for a small UK seller is not insurable. Work out which risks a policy answers, which your courier answers, and which are just yours.
date: 2026-08-06
author: Sailo team
cover: /blog/covers/insurance-and-what-can-go-wrong.svg
...
## The three that insurance genuinely answers
...
## The risks a policy will never touch

This is where most small sellers actually lose money, and there's no premium for any of it.

**Someone says they paid.** No insurer is interested. The answer is a process: never dispatch on a screenshot, confirm against your own bank, and have a script ready that doesn't accuse anyone. [What to say when a buyer says they paid](/en/blog/what-to-say-when-a-buyer-says-they-paid) is the one to keep in your notes.

**A refund you didn't plan for.** Answered by a written policy that you decided on calmly, before it happened, rather than at 11pm with an angry message on your phone. [Writing a refund policy people trust](/en/blog/writing-a-refund-policy-people-trust) is the version that reduces refunds rather than inviting them.
...
## How to buy the cover you do need
...
1. **What's the limit, and is it per claim or per year.** Two very different products at similar prices.
2. **Does it cover the events you attend**, including any outside your usual area.
3. **Does it cover product liability as well as public liability**, or is that a separate line you have to add.
4. **Does it cover your stock, and where.** At home, at a market, in a van overnight, in transit. Vans overnight are a common exclusion.
5. **What's the excess**, and is it worth claiming at all for the size of loss you'd realistically have.
6. **What happens to claims made after you cancel.** Some liability cover only answers claims made while the policy is live, which matters if you stop trading.

Then ask your courier the same kind of question about compensation limits, because for most online sellers the courier is the thing that goes wrong most often and the compensation is the cover you're actually relying on. [Choosing a courier you can trust](/en/blog/choosing-a-courier-you-can-trust) goes through what to compare beyond price.

## Where Sailo sits in all this, plainly
...
While you're in the mood for paperwork, the other document that removes arguments before they start is a set of terms a human will actually read. [Writing terms people will actually read](/en/blog/writing-terms-people-will-actually-read) covers what to put in them, and [do you need to register your business](/en/blog/do-you-need-to-register-your-business) is the piece that sits above all of this.
