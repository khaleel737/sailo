---
title: How to handle price negotiation without losing the sale
description: Every buyer asks for last price. Where to build the room, what to give instead of money, and the one sentence that holds a number without killing the deal.
date: 2026-08-06
author: Sailo team
cover: /blog/covers/pricing-for-a-market-that-haggles.svg
coverAlt: A large price tag
tags: [pricing, nigeria]
---
...
## Haggling is a script, not an attack
...
## Holding a price in one sentence
...
## What to say to "my friend sells it for ₦30,000"
...
## When to actually drop the number
...
If you're planning something bigger, [how to run a discount without losing money](/en/blog/how-to-run-a-discount-without-losing-money) covers the maths on what a percentage off actually does to your margin, which is usually worse than sellers expect.

## Worked example: Tunde, sneakers, Yaba
...
- The price is on the page. Every model, every size, no "DM for price".
- His stock answer to "last price" is one line: "₦42,000. Free delivery on the island and mainland, that's ₦2,500 saved."
- Two pairs is ₦78,000, published, so he never has to invent a bundle mid-conversation.
- He drops the number for exactly two reasons: box damage, which he photographs and states, and buyers on their fourth pair.
...
Nothing about his setup is unusual for Lagos. Instagram is the shop window, WhatsApp is the counter, and bank transfer is the till. The rest of that operating pattern, including the confirmation rule that stops fake alerts costing you stock, is in [how to start an online business in Nigeria](/en/blog/selling-online-in-nigeria).

## Time-wasters, and the filter
...
None of those offend a genuine buyer. All of them lose the person who was never going to pay. If your DMs are full of people who negotiate and vanish, [dealing with fake orders and time-wasters](/en/blog/dealing-with-fake-orders-and-time-wasters) has the specific filters.
...
Then put your prices on a page where buyers read them before they message you. If you sell in a market where the naira itself keeps moving under your costs, the harder version of this problem is in [selling in a currency that moves](/en/blog/selling-in-a-currency-that-moves).
