---
title: How to sell workout plans online without promising results you cannot deliver
description: A PDF plan is not passive income. Here are the real support hours, the refund rate you should expect, and the claims that get a coach in trouble.
date: 2026-08-06
author: Sailo team
cover: /blog/covers/selling-fitness-plans.svg
coverAlt: A parcel box drawn in outline
tags: [fitness, digital, niches]
---
...
## What you can say, and what you should not
...
## Testimonials, before-and-afters, and the honest version

Transformation photos sell. They also imply a promise, which is exactly what you just decided not to make.

If you use them:

- **Written permission, every time.** A message saying "sure, go ahead" is enough, and keep it.
- **No retouching, no lighting tricks.** Same lighting, same time of day, same pose.
- **Put the timescale on it.** "14 months, with two breaks." A photo without a duration reads as six weeks and people will assume six weeks.
- **Show a range, not only the outliers.** Your best result and a typical one, side by side, is more persuasive than two spectacular ones, because it's believable.
...
## The product decision, and the maths behind it
...
Its weakness is obvious: churn is total. Every sale is a new customer, and once you've sold to everyone in your audience who wanted it, sales fall off a cliff until you grow the audience. A membership at $29 with 100 members is $2,900 a month, which sounds better than $3,900 once, and it is, right up until you're writing programming on Christmas Eve. [Memberships versus one-off sales](/en/blog/memberships-versus-one-off-sales) works through which one suits which kind of person.
...
## Build the plan for one person, not for everyone
...
## Delivery, refunds and the file that gets shared
...
- **Put the buyer's name and email on the PDF.** Not as a threat, just as a fact. It ends most passing-it-around-the-group-chat behaviour.
- **Set a download limit and an expiry** on the link, so it can't be posted somewhere and served forever from your bandwidth. Files unlock on payment confirmation, and download limits and expiry are available.
- **Price at a level where copying feels worse than paying.** $39 is annoying to steal. $299 is worth the trouble.

[Stopping people sharing your paid files](/en/blog/stopping-people-sharing-your-paid-files) has the rest of what actually helps, which is less than you'd hope and more than nothing.
...
## Worked example: Kelsey, Austin, a $39 dumbbell plan
...
Her costs are almost nothing except the card setup. Card payments need a Stripe account cleared for charges, plus {{fee_range}}% of the goods to Sailo, which is 39 cents to $1.17 on a $39 plan depending on her plan, and Stripe's own fee on top. She does not need a paid plan to take cards — the free plan settles them at {{fee_free}}%, and what a paid plan buys is a smaller cut. In a 14-sale month that's $546 of revenue and about $16 of Sailo commission on free. Moving to Business drops the rate to {{fee_business}}% — $5.46 — but adds ${{business_monthly}} a month, so it only pays once she is selling roughly ${{business_monthly}} ÷ 0.02 a month, about $2,450. That's the honest shape of it: below that the free plan is cheaper, and a quiet quarter costs her nothing at all.
...
## Pricing, and the trap of the $9 plan
...
If you'd rather start with time than with a file, [how to sell files and time online](/en/blog/how-to-sell-files-and-time-online) covers both sides and which order to do them in.
