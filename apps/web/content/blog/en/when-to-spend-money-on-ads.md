---
title: When to spend money on ads
description: For most small sellers the answer is not yet. Work out the most you can pay for one customer first, because that number decides whether ads can work at all.
date: 2026-08-06
author: Sailo team
cover: /blog/covers/when-to-spend-money-on-ads.svg
...
## The number: the most you can pay for one customer
...
## Three things that have to be true before you spend anything

**One: something already sells without paying for traffic.** You need proof a stranger will buy, at your price, without you personally messaging them. Not friends. Strangers. If you can't point at three of those, you're about to pay to find out something you could learn for free by asking forty people, which is what [getting your first ten orders](/en/blog/getting-your-first-ten-orders) is about.

**Two: your page converts the traffic you already have.** Go and count. How many people opened your shop last month, and how many bought? If it's 200 and zero, ads make it 2,000 and zero. Fix the shop first. [What to do when nobody is buying](/en/blog/what-to-do-when-nobody-is-buying) is a six-step diagnostic that costs nothing.
...
## What Tomas spent in Bristol, and what it bought
...
What he did with the next £200: nothing. He spent it on ingredients and put the hours into two things instead. He messaged every past customer at the four-week mark, since a bottle of hot sauce lasts about that long, which is the whole idea in [how to get repeat buyers](/en/blog/how-to-get-repeat-buyers). And he asked twenty customers whether they knew one person who'd like it.
...
## Where the £200 goes further

Ranked by what they tend to return for a small seller, best first:

1. **Messaging past customers at the right moment.** Costs nothing but time, converts at maybe one in three, and the customers are already yours.
2. **Asking for referrals properly.** One specific ask to one specific person, in the week after their order lands. [Asking customers for referrals](/en/blog/asking-customers-for-referrals) has the wording, and the traffic it produces converts better than anything you can buy.
3. **Fixing the page.** A hidden postage cost or a first product nobody wants is costing you more than any campaign will earn.
4. **Better photography of your best seller.** One product shot properly beats twenty shot badly, and it improves everything downstream including your eventual ads.
5. **Product samples to ten strangers.** Ten sets of hot sauce cost Tomas about £93 in materials and would have produced feedback, photos and probably four customers.
6. **A free-delivery threshold.** Raises average order value, which raises your margin per customer, which is the number that decides whether ads ever become possible.
...
## When ads genuinely are the right answer
...
## What the platforms are actually good at
...
1. **Margin on one order,** with your own time in it at a real hourly number.
2. **Your current conversion rate**, from whatever traffic you already have. Orders divided by visitors, over the longest period you have. If you don't have enough traffic for that number to be stable, [what conversion rate you should expect](/en/blog/what-conversion-rate-should-you-expect) explains why the published benchmarks won't help you either.
3. **Multiply them.** That's the most you can pay for a click and break even. Halve it. That's your actual ceiling.
