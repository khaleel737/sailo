---
title: Why you should own your customer list
description: Followers are rented and the rent changes without notice. A list is a file you hold with five columns in it, and the moment to build it is the order itself.
date: 2026-08-06
author: Sailo team
cover: /blog/covers/owning-your-customer-list.svg
coverAlt: A crowd with a few picked out
tags: [comparison, customers]
---
...
## The collection moment is the order
...
- **The order details themselves.** Every order already carries a name and a contact method. This is your list. You just haven't written it down anywhere yet.
- **A line in the order confirmation.** "I message this number about twice a month when there's a new batch. Reply STOP any time and I'll take you off." One sentence, said plainly, at the moment they're already reading.
- **A card in the parcel.** Costs a few cents, works surprisingly well, and can carry a QR code to the place you want them next.
- **Asking, in the DM, after the good outcome.** When someone messages to say they loved it, that's when you ask whether they want to hear about the next run.
...
## Say what you'll send, then send exactly that
...
## Huda, Dubai, and the list that was already in her phone
...
She also started a second channel, a WhatsApp Channel for the one-way announcements, keeping the broadcast list for the smaller group of repeat buyers. Different tools for different intimacy, and [using WhatsApp Channels to sell](/en/blog/using-whatsapp-channels-to-sell) covers the difference properly.
...
## What Sailo does here, and what it very deliberately doesn't
...
If you're weighing up which tool to build all this on, [what happens if the tool you sell through shuts down](/en/blog/what-happens-if-a-tool-shuts-down) is the exit-first way to compare them, [moving off a platform without losing customers](/en/blog/moving-off-a-platform-without-losing-customers) is the runbook for the switch itself, and [link in bio tools compared](/en/blog/link-in-bio-tools-compared) covers what each category takes from you while you're there.
