...
description: Nine hundred followers is enough to earn money, just not the way most advice assumes. What to sell, what order to do it in, and when to wait a while.
date: 2026-08-06
author: Sailo team
cover: /blog/covers/turning-an-audience-into-income.svg
coverAlt: A crowd with a few picked out
tags: [creators, monetisation]
---
...
1. **How many people message you privately in a month.** Not comments. Messages. This is your actual audience.
2. **How many of those messages are questions you could answer for money.** "Where'd you get that jacket" is not one. "How do you do the shading on the second layer" is.
3. **How many people have ever asked you to do something for them.** Even once. Even badly. Even for free.
...
## The four ways money reaches a creator
...
## Platform payouts are a bad first job
...
## Start with the question you keep answering
...
There's a whole method for pulling an offer out of content you've already published, including how to tell which posts are actually signals, in [turning free content into a paid offer](/en/blog/turning-free-content-into-a-paid-offer).

And if you genuinely can't find anything to sell because you don't make a physical thing, that's a solvable problem with a specific list of answers: [what to sell when you have no product](/en/blog/what-to-sell-when-you-have-no-product) goes through them in order of how fast each one can produce a first sale.

## The arithmetic that makes a small audience work
...
The precise version of this decision, including the price to pick when you have literally no data, is in [how to price your first paid offer](/en/blog/how-to-price-your-first-paid-offer).

## Worked example: Tobi, illustrator, Lagos
...
- One offer, written down: a single-figure portrait, head and shoulders, digital file, ₦30,000. Two revisions. Seven working days.
- A second offer for the people who flinched at ₦30,000: the same thing at A5, line art only, no colour, ₦12,000.
- Bank transfer details on the page, with a reference format: `TOBI-` plus the buyer's first name.
- A pinned post with the two prices and the link. Not a story. A pinned post, because stories expire and the question doesn't.

First month: five orders. Four at ₦12,000, one at ₦30,000. ₦78,000. Second month: three orders, but two of them at ₦30,000, because the cheap one now reads as the sample rather than the product.
...
1. **Write the offer as one sentence with a price in it.** If you can't, you don't have an offer, you have an intention.
2. **Post the price before you build the thing.** Ask who wants it. If nobody asks how to pay, you've just saved yourself three weekends. This is the single most useful hour in the whole process and almost everybody skips it.
3. **Set up one way to be paid.** Whatever your buyers already use. A bank transfer field, a UPI ID in your instructions, cash if you meet them.
4. **Make one link that shows the offer, the price and the pay button on the same screen.** Not a page of buttons pointing at other pages.
5. **Deliver the first one badly and on time.** On time matters more.
6. **Ask that buyer for one sentence you can quote.** Do it the day you deliver, not a month later.
7. **Only now** consider whether the thing should be productised, automated, or made bigger.

Steps 1 and 2 take an evening. Most people spend that evening comparing platforms instead.

## Getting paid is a separate problem from selling
...
The reason people don't buy is rarely the reason creators assume, and it's worth knowing the real list before you conclude your audience is worthless: [why your audience does not buy](/en/blog/why-your-audience-does-not-buy) works through the causes in order of how common they are.

## Sponsorship money and your own money aren't the same money
...
Both routes are legitimate. They fail in different ways and suit different temperaments, and the comparison is more even-handed than most creator advice admits: [brand deals versus selling your own thing](/en/blog/brand-deals-versus-selling-your-own-thing) lays out the cash timing, the ceilings and the specific case for doing both.
...
What it won't do is make you a living immediately. Making the first $1,000 is a specific problem with a specific shape, and the shape depends far more on the price you picked than on the size of your following: [the first thousand dollars online](/en/blog/the-first-thousand-dollars-online) does the arithmetic three different ways.

And if you've been holding off because your numbers feel too small to bother, the threshold is much lower than the advice industry implies. [You do not need 100k followers](/en/blog/you-do-not-need-100k-followers) covers what each follower band can actually support.
