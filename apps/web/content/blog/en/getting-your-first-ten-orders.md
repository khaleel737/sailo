...
Here's where Sailo's own limits are worth saying out loud rather than burying. The free plan caps you at {{free_products}} products, which is plenty for a first catalogue and not plenty for a real one. Card payments carry {{fee_range}}% of the goods on each card order — {{fee_free}}% on the free plan, {{fee_business}}% on Business — and at ten orders a month the rate is small either way. And there is no mobile money rail. If your buyers pay you by M-Pesa or GCash, Sailo will carry the catalogue and the order and the address, and you will still be the one checking your phone for the payment confirmation. That's a genuine gap, not a positioning statement.
