---
title: When a marketplace beats your own shop
description: A marketplace brings its own buyers and your own link does not. That is the whole trade. Here is the arithmetic on when each one actually wins.
date: 2026-08-06
author: Sailo team
cover: /blog/covers/when-a-marketplace-beats-your-own-shop.svg
...
## The one thing a marketplace does that you cannot
...
## The one thing your own shop does that a marketplace cannot
...
## Demand you capture versus demand you create
...
## What a marketplace charges you beyond the commission

The percentage is visible. These aren't, and they add up.

- **Price compression.** Your listing sits beside forty similar ones sorted partly by price. Over time that pushes what you can charge down, in a way that never happens on your own page where you're not next to anybody.
- **Ads that become non-optional.** Once enough sellers in your category are paying for placement, organic ranking is worth less, and the ad spend is a second commission you volunteered for.
- **Their returns policy, not yours.** You inherit rules written for a platform with millions of listings, and they're not written with your unit economics in mind.
- **No customer relationship.** Covered above, but it's the biggest cost and the one that doesn't appear on any statement.
- **Platform risk.** Ranking changes, category changes, policy changes, suspension. None of it is announced in advance and none of it is appealable quickly.

None of that makes marketplaces a bad deal. It makes them a deal, with terms, and the terms are worth reading.

## When the marketplace clearly wins

Be honest with yourself about these. If two or more are true, list there and stop agonising.

- You have fewer than about 500 engaged followers, or none.
- What you sell is something people search for by name.
- You sell a product other people also sell, and your edge is craft or price rather than personality.
- You're selling internationally and the marketplace handles the customs paperwork and the currency.
- You want your first sales this month, not after six months of learning to post.
- Your product photographs well in a grid and doesn't need explaining.

## When your own link clearly wins

- Your buyers already follow you, and you can name a few of them.
- What you sell is unusual enough that nobody knows the search term for it.
- Your margin is thin enough that a double-digit commission removes most of the profit.
- You want repeat orders and you're willing to message people.
- You sell custom or made-to-order work where the conversation is part of the product.
- You take payment on a rail the marketplace doesn't support anyway, like a local bank transfer or cash on delivery.
...
Send everything you post on social to your own link. Every single time. That is the one flow where you're paying nothing to nobody, and it's the flow most sellers accidentally route through a marketplace out of habit. The wider version of that argument is in [selling on social media without a website](/en/blog/selling-on-social-media-without-a-website), and the fee arithmetic on small orders specifically is in [how payment fees eat a small order](/en/blog/how-payment-fees-eat-a-small-order).
...
The costs, since this is a comparison and you should be able to check the arithmetic. The free plan is $0 for {{free_products}} products. On bank transfer, cash on delivery, and orders handed off to WhatsApp, Instagram, Telegram, email or phone, Sailo takes no commission at all, because Sailo never holds the money. Card payments need a Stripe account Stripe has cleared for charges, and Sailo takes {{fee_range}}% of the goods on each card order, after discounts and excluding delivery and tax. Charges land in your own Stripe account, not in Sailo's.
