---
title: Christmas orders without the chaos
description: Backwards planning for a UK small shop. The last posting dates, the cut-off you publish, the private one you keep, and how to say no in December.
date: 2026-08-06
author: Sailo team
cover: /blog/covers/christmas-orders-without-the-chaos.svg
...
## Get the courier's dates first, in writing
...
- The slowest economy or second-class service has the earliest date, typically the back half of the third week of December.
- First class or next-day is a few days later.
- The tracked and guaranteed services are last, and they cost meaningfully more per parcel.
- International dates are much earlier, and the difference between Europe and everywhere else is weeks, not days.
...
## The three dates, worked backwards
...
## Capacity is the cut-off, not the calendar
...
## Personalised and made-to-order needs its own, earlier date
...
## The wave you're not expecting

December orders don't arrive evenly. They arrive in three lumps.
...
1. **Collection in person.** If you're anywhere near the buyer, this works after every courier has stopped. Say it early, from the 10th, not as an emergency measure on the 22nd.
2. **A printable card.** If you sell something you can't ship in time, a well-made PDF the buyer prints and puts in an envelope covers the "I need something to give them on the day" problem. Digital files unlock on payment confirmation, so this genuinely does work at 11pm on Christmas Eve. It's also the one thing you can sell with no capacity limit at all.
3. **January dispatch, sold honestly.** "Ordered now, made and posted in the first week of January" is a real offer and some people take it. Do not sell it as Christmas delivery and hope.
4. **A plain no.** "I can't get it there in time and I'd rather tell you now than take your money." You will be surprised how well this lands. Say it fast, say it once, and offer the January option in the same message.

The version of that conversation that keeps the customer is in [what to do when you cannot fulfil](/en/blog/what-to-do-when-you-cannot-fulfil).

## Worked example: Tom, engraved boards, Sheffield
...
- **Realistic output:** 6 boards on a weekday evening, 18 on a Saturday. Across the first three weeks of December that's about 96 boards if nothing goes wrong.
- **He caps at 70.** The 26-board gap is the machine breaking, the wrong wood arriving, and a week in which he does not want to be awake at 1am.
- **Personalised cut-off is the 8th.** Non-personalised stock boards close on the 15th.
- **Private cut-off, the 11th and the 18th.** He'll say yes past the published date to repeat buyers, and to anyone who's flexible on the wood.
- **Oak blanks ordered on 1 November.** Enough for 90 boards, which is more than his cap, because a blank he doesn't use in December he uses in February.

The thing that changed his December wasn't the cap. It was reading the name back. Every order gets a confirmation message that says "engraving: THE HARRISONS, all caps, on the short edge, confirm please". Roughly one order in twelve comes back with a correction. Before he did that, those twelve were the refunds. The [order confirmation message](/en/blog/how-to-write-an-order-confirmation) is the cheapest quality control in the business, and December is when it pays for itself.

He also stopped taking phone orders after the 10th. Everything in writing, so there's a record of what the buyer asked for.

## Reconciliation in December
...
If December is the peak of a year you'd like to run more deliberately, [planning a year of drops](/en/blog/planning-a-year-of-drops) sets out the rest of the calendar, and [delivery times you can actually promise](/en/blog/delivery-times-you-can-actually-promise) covers how to phrase a window you can keep.
