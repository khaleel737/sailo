---
title: What conversion rate should you expect
description: Most quoted industry averages have no source you can check. Here is the one that does, why it is not about you, and how to read your own number instead.
date: 2026-08-06
author: Sailo team
cover: /blog/covers/what-conversion-rate-should-you-expect.svg
...
## The one number I could source, with its caveats attached
...
## Why the other numbers you'll find are not evidence
...
## Before anything else, define your denominator
...
- **Sessions.** Every visit, including the same person three times. Lowest number.
- **Unique visitors.** Deduplicated people. Higher, sometimes by half again.
- **People who opened a product page,** rather than the shop front. Much higher, because you've filtered out the browsers.
- **People who started an order.** Higher still, and this is checkout completion rather than conversion.
- **People who messaged you.** Very high, and a different measurement altogether.
...
## Your number is noisier than you think
...
## Your number is a mobile number, so compare it to mobile ones
...
## For a lot of small sellers, conversion isn't the right metric at all
...
## Do this instead of looking up a benchmark

Three columns, one row a month, in whatever you already use.

1. **Opens.** Whatever your denominator is. Write down which one you chose.
2. **Messages.** A tally.
3. **Orders that were actually paid.** Not orders placed.
...
Then split the first column by where the traffic came from, even roughly. That split is where the decisions are, and it's why [how to read your own numbers](/en/blog/how-to-read-your-own-numbers) is worth more than any industry average you'll ever be quoted.

And if you were about to spend money on traffic because the rate looked acceptable, do the split first. A 2.5% blended rate made of one great channel and two bad ones means paid traffic will land in the bad ones, which is exactly the trap in [when to spend money on ads](/en/blog/when-to-spend-money-on-ads). If your traffic is still measured in the low hundreds, none of this applies yet, and [getting your first ten orders](/en/blog/getting-your-first-ten-orders) is the job in front of you.
