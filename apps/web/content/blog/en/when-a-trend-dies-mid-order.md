---
title: What to do when a trend dies and you still have the stock
description: Stop the reorder, work out your weeks of cover, then pick the exit that recovers most cash. Discounting on your main channel is the last move, not the first.
date: 2026-08-06
author: Sailo team
cover: /blog/covers/when-a-trend-dies-mid-order.svg
...
## The first hour: stop what's still moving
...
## Dead or just slow? Weeks of cover tells you
...
Do it weekly for a month before you conclude anything, because one bad week is noise and four bad weeks is a trend in the other direction. And check whether the fall is the product or the traffic: if everything you sell dropped at once, the problem isn't the trend, it's that nobody's visiting, and [what to do when nobody is buying](/en/blog/what-to-do-when-nobody-is-buying) is a different piece of work entirely.
...
## Why postage decides everything on cheap items
...
So the rank order of exits for anything under about $10 or its local equivalent is: get rid of the parcel, not the margin. Bundles, local pickup, market stalls, add-ons, wholesale, in-person events. Every one of those removes the fixed cost that's actually killing the recovery. [How to work out delivery charges](/en/blog/how-to-work-out-delivery-charges) has the underlying arithmetic if you've never separated your fixed shipping cost from your margin.
...
## Protect the line that still sells

The instinct is to put a banner on your shop. Resist it for a fortnight and think about what the banner teaches.

A visible 40% off on your storefront tells every regular customer two things: that your prices have 40% of air in them, and that waiting is rewarded. Both are expensive and neither is reversible in a season. [How to run a discount without losing money](/en/blog/how-to-run-a-discount-without-losing-money) goes through the versions that don't do this.

Better shapes for clearing dead stock without repricing your brand:

- **A private message to past buyers**, not a public post. It's the same discount, seen by 200 people instead of 20,000, and those 200 are the ones most likely to take it.
- **A bundle**, which is a discount that doesn't have a percentage attached to it in anybody's memory.
- **A different channel.** A market stall, a local Facebook group, a car boot, a stallholder who'll take the lot. [Selling offline and online at once](/en/blog/selling-offline-and-online-at-once) covers running both without double-selling the same unit.
- **A different market.** Trends land in different places at different times. Something dead in one city can be six weeks early in another, and a wholesale buyer two hours away may be genuinely interested rather than doing you a favour.
- **An add-on threshold**, which converts dead stock into a higher average order value on the products that still work.
...
## What Sailo does and doesn't do while you're clearing
...
Before you buy the next thing, [what trends are worth chasing](/en/blog/what-trends-are-worth-chasing) has the lead-time test that would have caught this, and [planning a year of drops](/en/blog/planning-a-year-of-drops) is how the calendar looks when stock is committed against dates you chose rather than dates a feed chose for you.
