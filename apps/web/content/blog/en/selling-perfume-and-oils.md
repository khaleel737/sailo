---
title: How to sell perfume oils online in Nigeria
description: Decanting maths, the heat that ruins your stock, and why couriers get twitchy about fragrance. What a ₦4,000 roll-on really costs you to fill.
date: 2026-08-06
author: Sailo team
cover: /blog/covers/selling-perfume-and-oils.svg
coverAlt: A jar with a label
tags: [perfume, nigeria, niches]
---
...
## What a bottle actually costs you to fill
...
## Decanting maths, and the bottle you'll never get back
...
- The sprayer mechanism holds a couple of millilitres you can't easily recover.
- Every transfer loses a little to the funnel, the pipette walls and the neck.
- The last few millilitres come out slowly and messily and you'll leave some.
...
1. **Label it as a decant.** "10ml decant, transferred from a 100ml bottle purchased [date]" is the whole label. Never let a buyer think they're getting a full retail bottle.
2. **Never refill an empty designer bottle and sell it as sealed.** Obvious, and it happens constantly, and it's the reason Nigerian buyers are suspicious in the first place.
3. **Say "inspired by" when it's an oil impression.** An oil that smells like a designer scent is not that scent. Selling it under the designer's name is both a trademark problem and a returns problem, and describing it as "inspired by" costs you nothing. The buyers looking for oil impressions know exactly what they're buying and they're not confused by the word.
4. **Photograph the source bottle.** For decants, a photo of the actual bottle you're decanting from, with your handle written on a piece of paper next to it, is the single most persuasive thing in your listing.

Trust is the entire product in this trade, and it gets built long before anyone sends money. [Proving you are a real seller](/en/blog/proving-you-are-a-real-seller) is the general version. The perfume version is that your face, your name and a video of you filling bottles beats any amount of copy.

## Heat, light and the stock that changes while you sleep
...
- Keep bulk oil in a closed opaque box, on the floor, in the coolest room you have. Not on a shelf near a window.
- Keep filled stock the same way, and only bring out what you're photographing.
- Never store stock in a car, and never leave a parcel in a car boot overnight. A car boot in Kano in the afternoon is an oven.
- Amber and cobalt bottles exist for a reason. Clear bottles look better in photos and protect the contents worse. If you use clear, keep them boxed.
- Write the fill date on the bottom sticker of every bottle. When someone says "this batch smells different", you can check whether they're right, and half the time you'll find they are.
...
## Getting it there without a leak or a refusal
...
- Cling film or a small square of parafilm over the neck, then the cap on over it.
- Tape the cap. Actual tape, around the join.
- Each bottle in its own small zip bag. Not all of them in one bag, because the point is containment.
- Bubble wrap each bottle individually, then pack so nothing can move. Shake the box. If you hear anything, repack it.
- A rigid box, not a poly mailer. A poly mailer with three glass bottles in it is a bag of broken glass by the time it reaches Aba.

A single leaked bottle contaminates every other item in the bag, which is how one ₦4,000 loss becomes a ₦20,000 loss and an angry dispatch company. [Shipping fragile things](/en/blog/shipping-fragile-things) covers the general packing method; the fragrance addition is the film under the cap and the individual bags.

## Worked example: Halima, Kano, sixty bottles a month
...
## The money, and the part Sailo cannot do
...
That means the "I've sent it" moment is still yours to verify, every single time, and there's a whole genre of buyer who sends a screenshot of a transfer that never leaves their account. Never pack against a screenshot. Pack against your own banking app, and [how to know a bank transfer actually arrived](/en/blog/how-to-know-a-bank-transfer-actually-arrived) turns the checking into a five-minute habit rather than a running anxiety. The broader picture for this market, including registration and separating your money, is in [selling online in Nigeria](/en/blog/selling-online-in-nigeria).

## Month five, when it goes wrong
