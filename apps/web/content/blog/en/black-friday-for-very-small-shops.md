---
title: Black Friday for very small shops
description: A discount you cannot fund is a loss you scale. The arithmetic of what a percentage off really costs, and what to sell in November instead of price.
date: 2026-08-06
author: Sailo team
cover: /blog/covers/black-friday-for-very-small-shops.svg
...
## Work out what you'd actually clear
...
1. Retail price.
2. What the goods cost you: materials, or wholesale cost, plus packaging.
3. What it costs to get it to a buyer: postage, and the packing time if you're honest about it.
4. What the payment takes. Card processing is a percentage plus a fixed fee, and the fixed fee is what mauls small baskets.
...
If you want the fee side of that done properly, [how payment fees eat a small order](/en/blog/how-payment-fees-eat-a-small-order) has the arithmetic on small baskets, including why a fixed per-transaction fee hurts a $22 order far more than a $60 one.
...
If you're going to test any discount at all, the mechanics of doing it without wrecking your baseline are in [how to run a discount without losing money](/en/blog/how-to-run-a-discount-without-losing-money).
...
**Decide the cut-off for Christmas delivery before you launch.** A November discount that generates orders you can't ship until the third week of December is a customer service problem wearing a sales costume. The dates and the backwards planning are in [Christmas orders without the chaos](/en/blog/christmas-orders-without-the-chaos).

## Worked example: Dana, candles, Portland
...
- A **two-candle gift set at $56** (a 12.5% discount on the pair) in a single box, one postage. Contribution on the set: about $25, which is better per order than a single at full price.
- **40 sets, capped and stated.** They sold out in four days.
- A **free hand-poured tea light** with every order over $50, costing her $0.90.
- No shop-wide sale. Everything else stayed at full price all week.
...
The other thing she did, which was free: she counted those Black Friday buyers again in March. Eleven of the 40 set buyers had ordered again. That's a number worth having, and if you never measure it you'll keep running promotions on faith. [How to get repeat buyers](/en/blog/how-to-get-repeat-buyers) is where the follow-up sequence lives.

## The week after is the expensive one
...
- **You sell handmade and you're already at capacity.** More demand at a lower price is a worse business, not a bigger one.
- **Your margin is under 35%.** The table above says the volume you'd need doesn't exist.
- **You've been trading under six months.** You don't yet know your baseline, so you won't be able to tell whether the promotion did anything.
- **Your buyers are gift buyers who'll buy in December anyway.** Discounting in November just moves December's revenue backwards and makes it smaller.
...
If November's promotion is really about shifting stock you regret buying, that's a different problem with a different answer, and it's in [end of year stock clearing](/en/blog/end-of-year-stock-clearing).
