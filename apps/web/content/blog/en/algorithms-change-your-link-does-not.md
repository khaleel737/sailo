---
title: Algorithms change, your link does not
description: Reach is a loan the platform can call in. Here is what actually survives a bad month, and the weekly habit that builds it before you need it.
date: 2026-08-06
author: Sailo team
cover: /blog/covers/algorithms-change-your-link-does-not.svg
coverAlt: A profile with a stack of links below it
tags: [platforms, ownership, selling]
---
...
**A list of people who already bought.** Phone numbers, emails, addresses. This is the real asset and almost nobody builds it deliberately. It's also the only thing on this list that gets more valuable every month, which is why it's covered on its own in [owning your customer list](/en/blog/owning-your-customer-list).

Everything else, follower counts included, is weather.

## The order of durability
...
- **Your product photos and copy.** Yours, on your own device, if you keep them.
- **Your customer list.** Yours, if you can get it out.
- **Your name.** Yours, if you've been consistent enough that people know it as a word rather than as a tap.
...
## Spreading across five platforms is not diversification
...
- **Reach layer.** One platform, done properly. Maybe two if the second is cheap to run.
- **Name layer.** One word, identical everywhere, said out loud.
- **List layer.** Phone numbers and past orders, in a file you own.
- **Money layer.** More than one way to get paid, because a rail can fail too. If every order comes through one bank app or one wallet, an outage is a lost weekend.
...
Which platform to actually concentrate on, and how to prove it with your own orders rather than a guess, is the subject of [which platform should you actually sell on](/en/blog/which-platform-should-you-actually-sell-on).

## Farida in Kano: 22,000 followers, gone on a Tuesday
...
## What to collect from every order, starting now

This is the part you can act on today, and it takes no tools.

From every order, keep:

1. **A name and a phone number.** The number is the one that matters in most markets, because it works on WhatsApp.
2. **What they bought and when.** So you can message the twenty people who bought the thing you're restocking, rather than announcing it to everybody.
3. **Their city or area.** Delivery zones, and knowing where to run a meet-up.
4. **How they found you.** One word. "TikTok", "Aunty Bisi", "group". Four weeks of this tells you more than any analytics screen.
...
- Copy any new customer details out of your chat apps and into one file you own.
- Save your product photos somewhere off-platform.
- Say your shop name out loud in one video or story. Not "link in bio". The name.
- Check that the link in every bio you have still works and still has current prices.
...
1. Open a spreadsheet. Four columns: name, number, what they bought, where they found you.
2. Fill in your last twenty orders from memory and from your chat threads. It'll take twenty minutes and it will be uncomfortable how many you can't reconstruct.
3. Pick one word as your name and change every bio to match it.
4. Put that fifteen-minute habit in your calendar for the same time every week.

None of that will help you this month. That's the point. Six months from now, when reach halves again for reasons nobody explains, the spreadsheet is what decides whether you shrug or panic. The overall shape of running a shop this way, without a website, is in [selling on social media without a website](/en/blog/selling-on-social-media-without-a-website).
