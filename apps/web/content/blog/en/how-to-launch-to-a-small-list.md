---
title: How to launch to a small list
description: "Launching a product to a small audience is not a campaign, it is about forty conversations. The seven-day shape, what to send, and what breaks."
date: 2026-08-06
author: Sailo team
cover: /blog/covers/how-to-launch-to-a-small-list.svg
coverAlt: A crowd with a few picked out
tags: [creators, launching]
---
...
What you're buying is the right to cancel. If eleven people reply, you build it. If two do, you've saved a month and lost a post, and you now know something specific about what your audience wants that no amount of thinking would have told you. [Testing a product before you make it](/en/blog/testing-a-product-before-you-make-it) goes through the ways to run this properly, including the versions where people put money down.
...
## The messages that actually do it
...
1. The specific reason you thought of them. One line, and it has to be true.
2. What the thing is, in one sentence, with the price.
3. An exit. "If it's not for you right now that's completely fine, I just didn't want you to miss it."
...
## Price the first one like a first one
...
What doesn't work is pricing so low that twenty sales don't cover the week you spent. Twenty sales at KSh 400 is KSh 8,000 and a week of your life. [How to price your first paid offer](/en/blog/how-to-price-your-first-paid-offer) has the full method, including what to do when you genuinely cannot guess.

## The card timing trap
...
If you're not sure card is worth switching on at all yet, [do you need card payments to sell online](/en/blog/do-you-need-card-payments-to-sell-online) does the arithmetic at low volume, and the answer for a first launch is usually no.
...
That list is the actual asset. A launch is a one-week event. The people who watched it and didn't buy are a permanent audience for the next one, and they're easier to reach if you own the addresses rather than renting attention from a feed. [Building an email list without a website](/en/blog/building-an-email-list-without-a-website) covers how to collect them when you've got no site to put a form on, and [turning an audience into income](/en/blog/turning-an-audience-into-income) has the wider picture of what a small following can actually support.
