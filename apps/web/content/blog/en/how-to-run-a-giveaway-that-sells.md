---
title: How to run an Instagram giveaway that actually sells
description: Most giveaways buy you followers who entered for a prize and never come back. Here is the version that ends with orders instead of a bigger dead audience.
date: 2026-08-06
author: Sailo team
cover: /blog/covers/how-to-run-a-giveaway-that-sells.svg
coverAlt: A wrapped gift box with a ribbon
tags: [instagram, growth, selling]
---
...
## The three entry mechanics, and what each recruits
...
## Make the prize your own product, and make it a normal one
...
## The entry that leaves you with something
...
1. Post the giveaway. Prize is one of your products, at the price it sells for, photographed the way your normal posts are photographed.
2. Entry is: **go to the shop link and enter there**, with your name and an email or a WhatsApp number.
3. Optional second entry for tagging a friend, sharing to a Story, or answering a question about the product. Optional, because it should not be the main gate.
4. State plainly that entrants will hear from you about the result and about new drops, and that they can say stop.
...
## The rules you are actually required to post
...
## Picking a winner people believe
...
## The part that makes the money: what you send the people who lost
...
- Say who won, so it is clear the thing was real.
- Say thank you.
- Give them a genuine reason to buy now: a small discount, a bundle, free delivery, or first access to a small batch.
- Put an end date on it. Four days is plenty.

Keep the discount modest. A giveaway entrant is already interested; you are removing the last bit of hesitation, not buying the sale. Twenty percent off a £24 mug is £4.80 of your margin and it is usually more than enough. How to size that without eating the whole margin is worked through in [how to run a discount without losing money](/en/blog/how-to-run-a-discount-without-losing-money).
...
## Nadia in Birmingham, £45 of mugs and £680 of orders
...
1. Prize: the same £45 pair. No hamper, no collaboration.
2. Entry was a form on her shop page. Name, email, and one line about which glaze they would pick, which is a question only someone who looked at the products can answer.
3. She posted it three times over five days: the announcement, a video of the mugs being glazed, and a last-call Story with the link sticker.
4. Two days before the draw she opened a small batch of eight jugs to entrants only, before anyone else saw them.
5. On draw day she filmed the pick, announced the winner by name, and emailed the other entrants a 15% code good for four days.
...
**You have fewer than a few hundred followers.** A giveaway amplifies existing reach. With almost none, you are giving away a product to one of the eleven people who already buy from you. Spend the time on getting the first orders instead, which is a different problem with a different answer: [getting your first ten orders](/en/blog/getting-your-first-ten-orders).

**You cannot fulfil a spike.** If eight extra orders in a week would break you, do not go looking for forty.

**You are doing it because engagement is down.** A giveaway will fix the number and not the cause. If people are not buying, the reason is usually the product, the price or the path to paying for it, and none of those get better because 1,400 strangers commented "done". [You do not need 100k followers](/en/blog/you-do-not-need-100k-followers) is the less flattering version of that conversation.
...
1. Pick one product you already sell as the prize. Not a bundle.
2. Write the rules once and save them in a note: prize, closing time with a timezone, who can enter, how the winner is drawn.
3. Make the entry go through your shop page and collect a name and an email or number.
4. Plan the thing you will sell to the entrants **before** draw day, and open it two days early.
5. On draw day: film the pick, announce publicly, message the rest with an offer that expires.

Run it once that way and count orders, not followers. If you want the same mechanic without giving anything away, the waiting-list version does most of the same work for a fraction of the cost, and it is in [building a waiting list for a drop](/en/blog/building-a-waiting-list-for-a-drop). And if you are still deciding whether Instagram is even where this energy should go, [which platform should you actually sell on](/en/blog/which-platform-should-you-actually-sell-on) answers it more bluntly than most.
