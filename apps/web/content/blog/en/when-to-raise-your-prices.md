...
description: Five signals that say your price is too low, the arithmetic on how much volume a rise can safely cost you, and the two sentences to send your regulars.
date: 2026-08-06
author: Sailo team
cover: /blog/covers/when-to-raise-your-prices.svg
...
## The signals that look like signals but aren't
...
## How much volume a price rise can cost you
...
If you've never worked out your true unit cost, that's the job to do before this one, and it isn't materials times two. [How to price what you make](/en/blog/how-to-price-what-you-make) has the seven cost lines and the two most people skip.

## Raise on a date, not in a mood
...
1. Write down every outstanding quote you've given, and the price you quoted. Honour all of them.
2. Decide what happens to anyone with an unpaid order sitting in your messages. Old price, always. It's cheaper than the argument.
3. Update the price everywhere at once. Your shop page, your highlights, the price list you send in DMs, the sheet you take to markets, the pinned post.
4. Update the photograph or the description of at least one thing, so the listing has visibly changed.
...
- Don't justify it with a cost breakdown. It invites a negotiation about your costs, which is not a negotiation you can win.
- Don't say "unfortunately". You've done nothing wrong.
- Don't promise it won't happen again. It will.
- Don't announce it three times. Repeating it makes it sound like you're not sure.
...
## Change something the buyer can see
...
This is why the order of operations matters. Reshoot first, reprice second. A tired photo with a new number on it is the hardest sale in this article, and the fix costs a sheet of card and one window: [how to photograph what you sell](/en/blog/how-to-photograph-what-you-sell) is the two-hour version.

## Worked example: mugs in Portland, $28 to $34
...
## Raising prices when the currency moves
...
- Reprice on a fixed day every quarter, whether or not anything looks urgent.
- Recalculate the cost of your top three inputs the week before, from actual receipts, not memory.
- Put a validity window on every quote. Seven days is normal and nobody argues.
- Hold a small buffer in the price, so a 5% move doesn't force a reprice that month.

Customers in a market where prices move expect prices to move. The thing they don't forgive is a number changing between the quote and the invoice. [Selling in a currency that moves](/en/blog/selling-in-a-currency-that-moves) goes further into holding a price you can actually honour.

## Raise the price or cut the discount
...
Work out what your average sale actually is once discounts land. If your $28 mug goes out at an average of $25.60, the honest starting point for this whole exercise is $25.60. [How to run a discount without losing money](/en/blog/how-to-run-a-discount-without-losing-money) has the version of that arithmetic that most shops find uncomfortable.
...
If keeping the people you already have is the real worry, that's a different job from pricing, and it's mostly about the second order rather than the first: [how to get repeat buyers](/en/blog/how-to-get-repeat-buyers) covers what to do in the fortnight after a parcel arrives.
