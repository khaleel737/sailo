---
title: Selling during a festival rush
description: Indian festival season triples your orders and then the courier stops picking up. Pickup capacity, RTO spikes, corporate gifting, and what to book early.
date: 2026-08-06
author: Sailo team
cover: /blog/covers/selling-during-a-festival-rush.svg
...
## The calendar moves, so anchor to the weeks, not the dates
...
- **Diwali** falls in October or November, and the whole gifting run is the fortnight leading into it.
- **Dhanteras**, two days before Diwali, is the single biggest buying day for metal, utensils, gold and anything auspicious. If you sell any of those categories, that one day can be a fifth of your quarter.
- **Eid al-Fitr and Eid al-Adha** move roughly eleven days earlier each year, and the date isn't finally confirmed until the moon sighting the night before, so your last two days of delivery are ambiguous by one day.
- **Raksha Bandhan, Onam, Durga Puja, Pongal, Ganesh Chaturthi** all have their own windows and their own regional weight.
...
## Pickup, not delivery, is the bottleneck
...
**Run two couriers.** Not for price, for redundancy. When one network jams in the week before Diwali, the other one is usually still moving, and a seller with only one account has no second option at all. Choosing them on the right criteria is covered in [choosing a courier you can trust](/en/blog/choosing-a-courier-you-can-trust).

## RTO climbs, and prepaid is your defence
...
## Corporate gifting is the quiet money
...
- **A quote, in writing, with a per-unit price and a total.** Usually before they'll talk seriously.
- **A GST invoice.** If you're not registered, a lot of companies simply can't buy from you, because they can't claim input credit. This is the single most common reason a small seller loses a corporate order.
- **A sample.** Send one, charge for it, credit it against the order.
- **A firm delivery date, and delivery to one address**, which is enormously easier for you than 200 individual parcels.
- **Payment by NEFT or RTGS**, often 50% advance and 50% on delivery, and often slower than you'd like.
...
The advance is the part to get right. A 50% advance on a ₹90,000 order is ₹45,000 in your account before you buy materials, which is the difference between funding the season and borrowing for it. [Taking a deposit before you start](/en/blog/taking-a-deposit-before-you-start) covers how to ask for it without losing the order.

## Buy the packaging in September
...
- **Same-city and metro:** normal transit plus one day.
- **Other metros and tier-2:** normal plus two to three days.
- **Tier-3, north-east, remote pin codes:** normal plus four to seven, and a separate, earlier cut-off.
...
## Worked example: Ritu, brass diyas and gift boxes, Jaipur

Ritu sells brass diyas and assembled gift boxes from a workshop in Jaipur. Her range:

- Set of four diyas, **₹649**. Materials and polish about ₹230.
- Gift box, diyas plus dry fruit plus a card, **₹1,199**. Costs about ₹520 assembled.
- Corporate box, customised with a company logo on the sleeve, **₹450 each at 200 units**.
...
1. **Corporate outreach started ten weeks out.** She emailed 40 local companies with a quote sheet and a photo. Two ordered: 200 boxes at ₹450 and 120 at ₹450. That's ₹144,000 on two invoices, half of it paid in advance, delivered to two addresses.
2. **Packaging bought in early September**, enough for 600 units.
3. **Prepaid discount of ₹50**, stated on every listing. Prepaid share went from about a fifth of orders to more than half.
4. **Confirmation message within the hour** on every COD order, requiring a YES.
5. **Second courier account opened** in September and used from the second week of October.
6. **Non-metro cut-off five days before Diwali**, published on the product page.
...
If you're building the shop rather than scaling one, [selling online in India](/en/blog/selling-online-in-india) covers the ground rules.
