---
title: Should you offer free delivery
description: Free delivery is a discount you pay out of margin. Here is the sum that tells you if a threshold earns its keep, and when baking it into the price is better.
date: 2026-08-06
author: Sailo team
cover: /blog/covers/should-you-offer-free-delivery.svg
...
## Three groups of buyers, and only one of them helps you
...
- **Too low** (say $25). Now 58 of his 100 orders qualify automatically. He hands out $261 of free shipping and almost nobody steps up, because almost nobody has to.
- **Too high** (say $75). Only 6 orders qualify, and the gap from a $30 basket to $75 is four extra pins. Nobody buys four extra pins to save $4.50. The offer is decorative.
...
## The other shape: build it into the price
...
## When free delivery is the wrong answer
...
## The half-measures worth considering
...
Any of these is a discount, and the arithmetic of running a discount without giving away your margin is the same arithmetic as here. [How to run a discount without losing money](/en/blog/how-to-run-a-discount-without-losing-money) covers the general case.

## Test it properly, or don't test it
...
## What Sailo does here, and the bit that will catch you out
...
Then work out your true cost per parcel, including packaging and your own time, because every number in this article depends on it. [How to work out delivery charges](/en/blog/how-to-work-out-delivery-charges) does that band by band. And if you're deciding this because your margins feel thin generally, check what the payment side is taking first, in [how payment fees eat a small order](/en/blog/how-payment-fees-eat-a-small-order). It's often the bigger leak.
