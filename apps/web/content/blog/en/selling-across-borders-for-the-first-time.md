---
title: How to sell to another country for the first time
description: The customs form, the fee at the door, and the transfer that arrives short. What actually goes wrong on a small seller's first international order.
date: 2026-08-06
author: Sailo team
cover: /blog/covers/selling-across-borders-for-the-first-time.svg
coverAlt: A delivery van in outline
tags: [cross-border, shipping]
---
...
## What actually goes on the customs form
...
## The fee at the door, and who eats it
...
## The money, and the transfer that arrives short
...
Stripe's UK pricing page in August 2026 listed cards issued outside the EEA at 3.15% + 20p, EEA cards at 2.5% + 20p, and a further 2% where a currency has to be converted. So a cross-border card order costs meaningfully more than a domestic one, and you should know that before you price international shipping. [How payment fees eat a small order](/en/blog/how-payment-fees-eat-a-small-order) shows how much of that lands on a small basket.

## Pricing in their currency or yours
...
Price in theirs and you convert better, because the number feels real to them, and you take the exchange rate risk. If your costs are in a currency that moves a lot against theirs, that risk is not theoretical. [Selling in a currency that moves](/en/blog/selling-in-a-currency-that-moves) covers how to price when the ground shifts under you.
...
## Delivery windows you can defend
...
[Shipping internationally for the first time](/en/blog/shipping-internationally-for-the-first-time) goes deeper into carriers, services and paperwork than I can here.

## Worked example: Tom, second-hand vinyl, Bristol
...
- Tracked service only, cost built into the shipping charge rather than absorbed.
- Customs description: "Used vinyl LP records, second-hand". Value: the sale price.
- One line at checkout and one line in the confirmation message: "Import duty and VAT may be charged on arrival in your country. These aren't included."
- Delivery quoted as 7 to 21 days for Europe, with the range explained.
- Card only for first-time international buyers. Bank transfer is fine for the four European regulars who've bought from him a dozen times.
...
## A second one, going the other way
...
## Where Sailo fits, and what it can't do
...
**Card carries {{fee_range}}% of the goods, and needs a Stripe account Stripe has cleared for charges.** Stripe's own availability varies a lot by country, so check that your country is covered before you plan an international strategy around cards. For sellers in several large markets, it isn't.
...
One country, done properly, teaches you more than a global shipping policy written from guesses. If you want the wider picture of what buyers in different places expect before they'll order at all, [what buyers expect in different countries](/en/blog/what-buyers-expect-in-different-countries) is worth reading before you write that page, and [how to take payment as a small seller](/en/blog/how-to-take-payment-as-a-small-seller) covers which rail to offer a buyer who has never met you.
