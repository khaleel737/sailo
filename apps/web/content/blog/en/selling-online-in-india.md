---
title: How to sell online in India without a website
description: A UPI ID, one link that shows prices, and a delivery plan. That combination takes real orders today, with no gateway, no setup fee and no developer.
date: 2026-08-06
author: Sailo team
cover: /blog/covers/selling-online-in-india.svg
...
## What you're actually missing, and it isn't a website
...
## UPI: the part India already solved
...
## Worked example: Priya, block-printed kurtas, Jaipur
...
## Registering, GST and the honest answer about tax
...
1. **Photograph six products properly.** Daylight, one surface, no ceiling lights. Six good photos will carry a shop for a year.
2. **Write the prices down and make them final.** Delivered price, so nobody argues about shipping later. Indian buyers will still ask for a discount. Decide your answer now rather than at 11pm.
3. **Put both on one page with a link.** Bio link, WhatsApp status, wherever people already find you.
4. **Put your UPI ID on that page, in text, plus a QR.** Never type it into a DM again.
5. **Decide your COD rule and write it on the page.** Which pincodes, how many days, what advance you take, what happens if the parcel is refused.
6. **Pick one courier and ship one parcel to yourself.** You will learn more from that one parcel than from a week of reading.
...
If most of your business runs through DMs, [how to take orders on WhatsApp](/en/blog/how-to-take-orders-on-whatsapp) covers the handoff in detail. And if you're still deciding which rail to build on before you build anything, start with [how to take payment as a small seller](/en/blog/how-to-take-payment-as-a-small-seller).
