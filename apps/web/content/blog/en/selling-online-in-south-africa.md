...
On Stripe's own global availability page, read in August 2026, South Africa appears under the extended network served by Paystack rather than as a launched Stripe country. Sailo does not support Paystack, whatever the marketing site may say. Which means that for a South African seller, no Sailo plan will reliably produce a working card button, and you should not build a plan around one.
