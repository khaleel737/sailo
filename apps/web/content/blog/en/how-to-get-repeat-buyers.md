---
title: How to get repeat buyers
description: A second order is a timing problem, not a loyalty problem. Work out when your product runs out, write it down, and be there on that day with one message.
date: 2026-08-06
author: Sailo team
cover: /blog/covers/how-to-get-repeat-buyers.svg
...
## Repeat buying is a timing problem
...
## Do the arithmetic on your own reorder clock
...
## Keep the one list almost nobody keeps
...
1. Name
2. How to reach them (the channel they actually reply on, not the one you prefer)
3. What they bought, including the variant
4. Date
5. Amount
6. Anything they said that was specific
...
If you take orders across DMs, comments and WhatsApp, this list is also the only place they all meet. Platforms lose your history. Accounts get restricted. Your list doesn't, and [owning your customer list](/en/blog/owning-your-customer-list) is worth reading before you find that out the hard way.

## The message that gets a second order
...
Send it once. If they don't reply, don't send a second one two days later. Wait until you genuinely have something new to say, and [how to follow up without being annoying](/en/blog/how-to-follow-up-without-being-annoying) covers where that line is.

## What Marilou's second orders looked like
...
## The second order costs you almost nothing
...
That's also why [getting your first ten orders](/en/blog/getting-your-first-ten-orders) has to come first. There's nothing to retain until there is.

## Things that quietly kill the second order
...
## Don't build a loyalty programme
...
Just do the arithmetic before you offer either. A free jar every third order is a 33% discount on the third order, which on ₱280 is roughly ₱93, and if your margin is ₱120 a jar you've given away most of it. [How to run a discount without losing money](/en/blog/how-to-run-a-discount-without-losing-money) works through exactly this kind of maths.
...
## What Sailo won't do for you here
...
Card payments do settle themselves, but they carry {{fee_range}}% of the goods, and if repeat orders are ₱410 each, that subscription needs a fair number of them before it pays for itself.
...
When the list gets to fifty or sixty names, it turns into something else: a group of people who'll recommend you if you ask properly. [Asking customers for referrals](/en/blog/asking-customers-for-referrals) is where that goes next.
