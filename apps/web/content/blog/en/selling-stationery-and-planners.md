---
title: How to sell planners online
description: Dated stock is worth nothing on 2 January. How to size a print run, pick paper people do not complain about, and carry February through July.
date: 2026-08-06
author: Sailo team
cover: /blog/covers/selling-stationery-and-planners.svg
coverAlt: An open book
tags: [stationery, planners, niches]
---
...
## Dated stock is worth zero on 2 January, not cost
...
## The planner year, month by month
...
Building the list that makes the pre-order work is the part that takes months rather than days, and it's worth starting in the spring. The mechanics of getting people to want something before it exists are in [building a waiting list for a drop](/en/blog/building-a-waiting-list-for-a-drop).

## Paper is the review, and it's the only review
...
- **70 to 80gsm.** Standard book paper. Cheap, light to ship, and it will ghost with most gel pens. Fine for a budget product if you say so on the page.
- **90 to 100gsm.** The sensible middle. Handles most pens, doesn't ghost badly, adds real weight to the shipping cost.
- **120gsm and up.** The premium tier. The pen people will notice and mention it. Your book is now noticeably heavier and thicker, which affects both postage and binding cost.
...
## Binding, page count and the returns you can avoid
...
## The undated and digital versions that carry February to July
...
**A digital version.** A PDF planner, hyperlinked, for tablet users. Zero print cost, zero shipping, zero dead stock, and it's the same file your printer already has with a few changes. It sells at a lower price and the margin is close to total. The practical side of selling a PDF, including how to deliver it and what to do about people sharing it, is covered in [how to sell PDFs without a website](/en/blog/how-to-sell-pdfs-without-a-website).
...
## Stickers, and the money that actually carries the quiet months
