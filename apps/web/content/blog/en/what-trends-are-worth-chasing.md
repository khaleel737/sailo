---
title: Should you sell trending products
description: Usually not, and the reason is arithmetic. Compare your supplier lead time to how long the trend has left, and chase demand with pre-orders instead of cash.
date: 2026-08-06
author: Sailo team
cover: /blog/covers/what-trends-are-worth-chasing.svg
...
## The only number that matters is lead time versus remaining life
...
## Three things get called a trend and only one deserves stock
...
Her actual best move was bundling them with her existing products as a free add-on above a $40 order, where they cost her $5 each in margin but pulled her average order value up by more than that, and cost nothing extra in postage. That's not a triumph. It's damage control, and it's covered properly in [when a trend dies mid-order](/en/blog/when-a-trend-dies-mid-order). If your instinct is to just run a sale instead, read [how to run a discount without losing money](/en/blog/how-to-run-a-discount-without-losing-money) first, because a percentage off a thin margin goes negative faster than people expect.
...
## The version that works: chase demand, not stock

Everything above is an argument against buying inventory on a guess. It isn't an argument against responding to what's popular, and the difference is where the money sits.
...
**Open a waiting list instead of a listing.** Lower commitment for the buyer, still a real number for you. Twenty names is a signal; twenty likes is not. [Building a waiting list for a drop](/en/blog/building-a-waiting-list-for-a-drop) covers running one that people actually join.
...
**Print on demand looks like the answer here and mostly isn't**, for reasons that have to do with margin and shipping times rather than with the idea. [Print on demand without the hype](/en/blog/print-on-demand-without-the-hype) goes through the numbers.

## Six questions for the supplier, before any money moves
...
1. **What's the unit price at 50, at 100 and at 200?** You want the shape of the curve, not one quote. If 50 costs 18% more than 200, the small order is cheap insurance. If it costs 60% more, the supplier is pushing volume and you should ask why.
2. **What's the real lead time, from payment clearing to goods leaving your building?** Then add the freight time yourself, and add a fortnight, because the first order with a new supplier always slips.
3. **Will you split the shipment?** Half now by air, half by sea, or two batches four weeks apart. Many will. It halves your exposure and it means the second half can be cancelled if the first half doesn't move.
4. **Can I have a sample before the bulk order?** Pay for it. A sample that arrives with a different finish from the photos is the cheapest bad news you'll ever buy.
5. **What happens if it arrives damaged or wrong?** Get the answer in writing before you're the one arguing about it. A supplier who won't answer this is telling you something.
6. **How many other buyers in my country are you shipping this to?** They may not answer honestly, and the answer is still informative. A cheerful "many!" is a warning.
...
## When a trend buy genuinely is worth it
...
The other legitimate case: a trend that's really a season. Buying sunglasses in spring isn't trend-chasing, it's a calendar, and it belongs in [planning a year of drops](/en/blog/planning-a-year-of-drops) with your other predictable peaks.

## Where Sailo helps and where it doesn't
...
## What to do instead of ordering 200 units
...
And spend the afternoon you would have spent on sourcing on your prices instead. [How to price what you make](/en/blog/how-to-price-what-you-make) will do more for this year's profit than any trend, and it doesn't arrive in a box.
