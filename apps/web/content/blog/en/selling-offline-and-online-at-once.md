---
title: Selling at markets and online at the same time
description: One box of stock, two places selling it. How to split what you bring, what the stall QR code is really for, and the Monday job nobody plans for.
date: 2026-08-06
author: Sailo team
cover: /blog/covers/selling-offline-and-online-at-once.svg
coverAlt: A parcel box drawn in outline
tags: [markets, offline, stock]
---
...
## The number that causes all of it
...
If your products have sizes and colours, this gets harder fast, and the variant side of it is worth reading separately in [how to handle sizes and variants](/en/blog/how-to-handle-sizes-and-variants).

## The stall QR code is not a checkout
...
- "Not sure? Scan and it's saved" for the browsers.
- "Sold out? Scan for the next batch" once you've cleared a line, which is the single highest-scanning moment of the day.
- "Scan for the ones that didn't fit in the van" if you genuinely have more at home.
...
Size, placement and why most printed codes never get used at all is its own subject, covered in [QR codes that actually get scanned](/en/blog/qr-codes-that-actually-get-scanned).
...
## What actually happens to the cash tin
...
1. **Thursday.** She counts everything and decides the split. Deep lines, meaning anything she has six or more of, stay listed online. Everything else comes off the site and goes in the market crate.
2. **Saturday night.** She prints the week's online orders on one sheet of paper. Item, name, and which shelf it's on.
3. **Sunday morning.** The printed sheet goes in her apron. Anything on that sheet is not for sale, no matter who's holding it.
4. **Sunday evening.** Whatever came back from the market gets counted and the numbers go back up online that night, not Monday.
5. **Monday.** Pack and post, then update stock again if she made anything new.
...
## The Monday job nobody plans for
...
- **Count out, not just back.** Photograph the crate before you load it. It takes four seconds and it settles every "did I bring the blue one" argument you'll have with yourself.
- **One crate per product line.** Mixed crates double your counting time.
- **Write the count on the crate lid in chalk pen.** Not on your phone. Your hands are full and your phone is in your back pocket under an apron.
- **Do it before you drive home, if you can face it.** The count you do on the pitch is accurate. The count you do on Monday includes the two you gave your mum.

## Pricing the same thing in two places
...
## What Sailo won't do about your Sunday
...
1. Count everything and write two numbers per line: how many exist, how many are coming with you.
2. Take the market units off your online shop, or set the online stock to the number that's staying home.
3. Print your unfulfilled online orders on one sheet and put it in the crate.
4. Make a SOLD OUT card now, with your link on it, laminated if you're feeling organised. You'll use it.
5. Sunday night, before anything else, put the returned stock back online.
