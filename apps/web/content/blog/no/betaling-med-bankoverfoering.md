---
title: "Betaling med bankoverføring når kjøperen helst vil vippse"
description: "Feltene kjøperen faktisk bruker, hva KID er og ikke er, hvorfor et skjermbilde ikke er en betaling, og hva Vipps-omveien koster ved førti ordrer."
date: 2026-08-06
author: Sailo team
cover: /blog/covers/betaling-med-bankoverfoering.svg
coverAlt: "En ordrebekreftelse ved siden av en kontoutskrift med en innbetaling markert"
tags: [betaling, bankoverføring, vipps]
---
...
## Feltene Sailo har, og de tre kjøperen faktisk bruker
...
## Kontohaver er feltet der du mister folk
...
## KID er ikke det du tror, og du har sannsynligvis ikke noe
...
## Vipps er ikke en betalingsmåte i Sailo
...
### Hva omveien koster ved førti ordrer i måneden
...
## Et skjermbilde er ikke en betaling
...
## Setningene du sender når noen sier de har betalt
...
## Kort finnes, og her er hva det koster
...
## Når bankoverføring begynner å koste for mye
...
Ofte ligger det mer å hente i å rydde opp i selve ordren enn i betalingen. Kommer bestillingene fortsatt inn som løse meldinger uten adresse og totalsum, begynn med [hvordan du selger på nett uten nettside](/no/blog/selg-pa-nett-uten-nettside). Og stemmer beløpene folk overfører systematisk ikke, ligger feilen som regel i fraktsatsen din og ikke hos kjøperne. Det regnestykket står i [fraktpriser for små selgere](/no/blog/fraktpriser-for-smaa-selgere).
