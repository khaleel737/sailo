...
import { LIFECYCLE_STEP_IDS } from "@/lib/lifecycle/steps";
import type { LifecycleShop, LifecycleState } from "@/lib/lifecycle/state";
import { LEGAL } from "@/lib/legal";
import { lifecycleMessage } from "./lifecycle-messages";
