...
import { handleLicenseActivate } from "@sailo/api/license";

/** `POST /api/license/activate` — see `@sailo/api/license` for the refusal rules. */
export async function POST(request: Request) {
  return handleLicenseActivate(request);
}
