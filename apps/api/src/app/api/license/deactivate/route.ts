...
import { handleLicenseDeactivate } from "@sailo/api/license";

/** `POST /api/license/deactivate` — see `@sailo/api/license` for the refusal rules. */
export async function POST(request: Request) {
  return handleLicenseDeactivate(request);
}
