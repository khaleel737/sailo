/*
 * Mounted on the API origin as well as on apps/web. Safe to mount twice because it
 * authenticates from the portal token in the query string and from nothing else —
 * EventSource cannot send headers, and no session cookie is consulted.
 */
