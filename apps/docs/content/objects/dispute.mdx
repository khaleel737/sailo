...
Also what [`GET /disputes`](/api/disputes) answers with. The event tells you a
case opened; the endpoint is how you re-read it later to see whether it was won,
and how you find the ones whose deadline is closest.
