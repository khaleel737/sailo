---
title: Cómo conseguir los primeros clientes online
description: Los diez primeros pedidos no salen del algoritmo. Salen de una lista de treinta nombres y de un mensaje que no parece cadena. Con el guion exacto.
date: 2026-08-06
author: Sailo team
cover: /blog/covers/como-conseguir-los-primeros-pedidos.svg
coverAlt: Una lista de nombres escrita a mano junto a una pantalla con el primer pedido
tags: [ventas, empezar]
---
...
## Los primeros diez pedidos no vienen de internet
...
- **Compraría.** Le sirve el producto para sí misma.
- **Regalaría.** Conoce a alguien a quien le sirve.
- **Difundiría.** No es su público, pero habla con mucha gente.
...
## Cómo escribir ese mensaje sin que parezca cadena
...
## Precio de los primeros pedidos: no regales, intercambia
...
- Precio completo a cambio de una foto usando el producto.
- Precio completo a cambio de una reseña escrita cuando llegue.
- Precio completo con un extra pequeño que a ti te cuesta poco, una bolsa de tela, una nota escrita a mano.
...
## Pide la reseña el día que llega el paquete
...
## Cuando nadie compra, son tres cosas
...
**Llegaron y no entendieron.** Mira tu página en el móvil de otra persona. Si en cuatro segundos no se ve qué vendes, cuánto cuesta y cómo se pide, ese es el problema y se arregla en una tarde. Está desglosado en [qué poner en el link de la bio](/es/blog/que-poner-en-el-link-de-la-bio).
...
En paralelo: haz las seis fotos de tu producto principal y revisa que tu página conteste las tres preguntas sin desplazarse. Prepara la respuesta rápida con tus datos de pago y tus zonas de entrega, porque la vas a necesitar el primer día. Cómo dejar eso listo en WhatsApp está en [cómo vender por WhatsApp](/es/blog/como-vender-por-whatsapp).

El domingo siguiente cuentas cuántos pedidos salieron de treinta mensajes. Ese número, y no el de seguidores, es el primero que vale la pena mirar. Si quieres el mapa completo de dónde va cada pieza, desde la publicación hasta el cobro, está en [cómo vender por Instagram sin página web](/es/blog/como-vender-por-instagram-sin-pagina-web).
