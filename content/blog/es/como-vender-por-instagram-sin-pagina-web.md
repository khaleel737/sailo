---
title: Cómo vender por Instagram sin página web
description: Instagram te trae gente, pero no cotiza, no anota direcciones y no cobra. Este es el reparto de tareas que sí funciona, con los números de un caso real.
date: 2026-08-06
author: Sailo team
cover: /blog/covers/como-vender-por-instagram-sin-pagina-web.svg
coverAlt: Una cuadrícula de fichas de catálogo con una de ellas resaltada y un precio visible
tags: [instagram, ventas]
---
...
## Instagram hace bien una de las tres partes de una venta
...
## El precio tiene que estar escrito en algún lado
...
## El enlace de la biografía tiene que ser la tienda, no un menú
...
Si alguna de las tres necesita otro toque, es una pregunta que el comprador responde yéndose. Hay una versión más larga de esto en [qué poner en el link de la bio](/es/blog/que-poner-en-el-link-de-la-bio), incluyendo qué va arriba y qué se puede borrar sin que pase nada.

## Cómo hacer que los pedidos lleguen ya escritos
...
1. **Qué.** El producto, con el mismo nombre que usas en tus publicaciones.
2. **Opciones.** Talla, color, sabor, cantidad. Escritas, no supuestas.
3. **Dónde.** Dirección completa, con el punto de referencia que tu mensajería realmente usa.
4. **Cuándo.** La fecha, si importa. Importa mucho más de lo que parece en comida y en regalos.
5. **Total.** Producto más envío, en un solo número, en su propia línea.
6. **Cómo paga.** Transferencia, contra reembolso, tarjeta.
...
Si tu canal principal es el chat y no el perfil, [cómo vender por WhatsApp](/es/blog/como-vender-por-whatsapp) entra en el detalle de etiquetas, respuestas rápidas y el mensaje de confirmación.

## Cobrar sin pasarela de pagos
...
## El error de orden de operaciones que cuesta caro
...
Y fotografía menos productos de los que crees. Seis fotos buenas sostienen una tienda un año; cuarenta fotos regulares no sostienen nada. Hay un método de una sola ventana en [cómo fotografiar productos con el móvil](/es/blog/fotografiar-productos-con-el-movil).
...
Arma la página, pon el enlace en la biografía, y en el próximo comentario que pregunte el precio responde con el nombre del modelo y nada más. Después ordena el envío, que es donde se pierde el margen sin que te des cuenta: [cómo calcular el envío](/es/blog/como-calcular-el-envio) tiene la fórmula del peso volumétrico y las tres preguntas que le tienes que hacer a tu transportadora.

Si todavía no tienes a quién venderle, empieza por [cómo conseguir los primeros pedidos](/es/blog/como-conseguir-los-primeros-pedidos) antes que por el catálogo. Una tienda perfecta sin visitas no es una tienda.
