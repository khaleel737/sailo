---
title: Rechnung schreiben als Kleinunternehmer
description: Was Sailo bei jeder Bestellung automatisch auf die Rechnung druckt, was du selbst ergänzen musst und wo die Grenzen des Systems für deutsche Fälle liegen.
date: 2026-08-06
author: Sailo team
cover: /blog/covers/rechnung-schreiben-als-kleinunternehmer.svg
coverAlt: Ein Rechnungsdokument mit einer hervorgehobenen Nummer
tags: [rechnung, buchhaltung, deutschland]
---
...
## Warum hier keine Grenzen und keine Sätze stehen
...
## Das Feld, das deinen Fall trägt
...
- Der Hinweis, den deine steuerliche Situation verlangt, in der Formulierung, die dir bestätigt wurde
- Deine vollständige Anbieteranschrift, falls sie nicht schon im Standortfeld steht
- Der Link auf deine Widerrufsbelehrung und deine Datenschutzerklärung
- Deine Bankverbindung, damit sie auf dem Beleg steht und nicht nur in der Bestätigungsmail
- Der Satz zur Zahlungsfrist, falls du eine hast
...
1. **Name.** Was der Käufer auf der Zeile liest. Für Deutschland naheliegend: "MwSt." oder "USt.".
2. **Satz.** Als Prozentwert. Welcher für deine Produkte gilt, klärst du mit deinem Steuerberater; ich nenne hier keinen.
3. **Enthalten oder aufgeschlagen.** In Deutschland erwarten Privatkunden Endpreise, in denen die Steuer schon drin ist. Steht die Einstellung auf "enthalten", zeigt die Rechnung den Gesamtbetrag und darunter den enthaltenen Steueranteil. Steht sie auf "aufgeschlagen", kommt die Steuer als eigene Zeile obendrauf, und der Käufer sieht am Ende mehr, als auf dem Produkt stand.
4. **Steuer auf Versandkosten.** Standardmäßig an.
...
- Präfix auf `KS` gesetzt, also `KS-0001`
- Standortfeld auf ihre vollständige Geschäftsanschrift, nicht nur "Nürnberg"
- Steuer-ID eingetragen
- Rechnungshinweis: der steuerliche Hinweis in der Fassung, die ihre Steuerberaterin ihr gegeben hat, darunter die URL zu ihren Rechtstexten, darunter ihre IBAN
...
1. Bin ich in meiner Situation umsatzsteuerpflichtig, und wenn nein, welcher Hinweis gehört auf meine Rechnungen, in welcher Formulierung?
2. Welche Pflichtangaben muss eine Rechnung in meinem Fall tragen, und ist die Liste bei kleinen Beträgen kürzer?
3. Reicht meine Ortsangabe, oder braucht es die vollständige Anschrift?
4. Wie lange muss ich Rechnungen aufbewahren, in welcher Form, und reicht dafür ein PDF?
5. Wie gehe ich mit Lücken in der Nummernfolge um, die durch Stornos entstehen?
...
1. Setz dein Rechnungspräfix, bevor die erste echte Bestellung kommt.
2. Trag das Standortfeld vollständig aus, so wie es auf deine Rechnungen gehört.
3. Vereinbare ein einmaliges Gespräch mit einem Steuerberater und geh die fünf Fragen oben durch.
4. Tipp den Rechnungshinweis in das freie Feld, in der Fassung, die dir bestätigt wurde.
5. Mach eine Testbestellung an dich selbst, öffne das PDF und lies es Zeile für Zeile.

Punkt 5 klingt nach Formsache und ist der Schritt, der die Fehler findet. Wenn dir dabei auffällt, dass deine Rechtstexte noch fehlen, fang mit [Impressumspflicht für kleine Shops](/de/blog/impressumspflicht-fuer-kleine-shops) an, weil der Link darauf ohnehin in dein Rechnungsfeld gehört. Was bei einer Rückabwicklung mit der ausgestellten Rechnung passiert, steht in [Widerrufsrecht im kleinen Shop](/de/blog/widerrufsrecht-im-kleinen-shop). Und wenn du noch entscheidest, ob du überhaupt einen eigenen Shop brauchst, sortiert [Online verkaufen ohne Website](/de/blog/online-verkaufen-ohne-website) die Reihenfolge.
