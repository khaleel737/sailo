---
title: Havale ile ödeme almak ve dekont geldiğinde ne yapacağın
description: Dekont bir ödeme değil, grafik tasarımı iyi bir ödeme niyetidir. Hangi bilgileri vereceğin, açıklamaya ne yazdıracağın ve gece yarısı ne diyeceğin.
date: 2026-08-06
author: Sailo team
cover: /blog/covers/havale-ile-odeme-almak.svg
coverAlt: Bir sipariş fişinin yanında duran banka hesap hareketleri ekranı
tags: [ödeme, havale]
---
...
## Vereceğin üç bilgi, ve herkesin unuttuğu dördüncüsü
...
## Havale, EFT ve FAST arasındaki fark seni nerede yakalar
...
## KOLAS ile IBAN yerine telefon numarası vermek
...
## Açıklama alanına isim değil kod yazdır
...
## Dekont geldiğinde neye bakarsın, neye bakmazsın
...
## Eksik gelen tutar için önceden verilmiş bir karar
...
## Ödeme görünmediğinde yazacağın iki mesaj
...
Siparişleri nasıl yazılı hâle getirdiğine dair uzun hâli [WhatsApp'tan sipariş almak](/tr/blog/whatsapptan-siparis-almak) yazısında var, çünkü kodun ve toplamın nereye yazıldığı en az kodun kendisi kadar önemli.

## Sailo havalenin neresinde duruyor
...
Kart tarafını da olduğu gibi yazalım, çünkü burası çoğu yerde şişiriliyor. Kart yöntemi Stripe üzerinde ve sadece Stripe üzerinde çalışıyor. Business planı gerekiyor, 19,99 USD/ay ya da 191,90 USD/yıl, artı Stripe'ın tahsilat için onayladığı bir Stripe hesabı. Sailo maldan 0,5% alıyor, indirim sonrası, kargo ve vergi hariç, ve para doğrudan senin kendi Stripe hesabına düşüyor.
...
## Sailo'nun senin yerine yapamadığı şey
...
Havale her kategoriye de uymuyor. Ucuz ve hızlı karar verilen ürünlerde alıcı parayı önden göndermek istemiyor, ve orada konuşma "kapıda ödeme var mı" ile devam ediyor. O tarafın maliyeti bambaşka: [kapıda ödeme nasıl çalışır](/tr/blog/kapida-odeme-nasil-calisir) yazısında reddedilen paketin sana gerçekte kaça mal olduğunun hesabı var. Kargo maliyetini yanlış hesaplayıp havaleden kazandığını orada kaybetmek de mümkün, [kargo ücreti nasıl hesaplanır](/tr/blog/kargo-ucreti-nasil-hesaplanir) yazısı desi formülünü ve pazarlıkta sorulacak soruları anlatıyor.
...
Ödeme tarafını oturttuysan geri kalan parçalar, yani fiyatın nerede yazılı olduğu ve siparişin sana nasıl geldiği, [website olmadan Instagram'dan satış](/tr/blog/website-olmadan-instagramdan-satis) yazısında baştan sona duruyor.
