---
title: Instagram biyografi linkinde ne olmalı
description: Biyografi linkin bir menü değil dükkân olmalı. Türk alıcı linke basınca ne arıyor, ilk ekranda ne durmalı ve neyi silsen hiçbir şey kaybetmezsin.
date: 2026-08-06
author: Sailo team
cover: /blog/covers/biyografi-linkinde-ne-olmali.svg
coverAlt: Telefonda açılmış bir katalog sayfası, en üstünde fiyat ve kargo süresi görünüyor
tags: [instagram, biyografi, satış]
---
...
## Bağlantı ağacı tanım gereği fazladan bir adım
...
Türkiye'de bu daha çok acıtıyor, çünkü alıcın aynı akşam senin gibi dört hesabı daha açık tutuyor. İçlerinden biri fiyatı ilk ekranda yazdıysa, senin istediğin o ikinci tıkın karşılığı yok. Keşfin, kararın ve tahsilatın hangisinin nerede durması gerektiğine dair daha geniş anlatım [website olmadan Instagram'dan satış](/tr/blog/website-olmadan-instagramdan-satis) yazısında.

## Kaydırmadan cevaplanması gereken üç soru

Linkin gittiği sayfanın ilk ekranı şunları cevaplamak zorunda.

1. **Ne satıyorsun.** Kategori değil, ürün. "Kadın giyim" cevap değil. "90'lar deri ceket, tek beden" cevap.
2. **Kaça.** Rakam. Aralık bile olur, "600 ₺ ile 1.400 ₺ arası" yeterli, ama ortada bir rakam olacak.
3. **Nasıl alıyorum.** Bir düğme, ve düğmenin üstünde basınca ne olacağını söyleyen tek bir cümle.

En çok atlanan üçüncüsü. Alıcı düğmeye basınca ne olacağını bilmiyorsa basmıyor, çünkü aklındaki ihtimal "şimdi bir form dolduracağım" ya da "kart bilgisi isteyecek". Düğmenin altına "WhatsApp'tan açılır, ürün ve adres yazılı gelir" yazdığın anda o belirsizlik kalkıyor. Siparişin sohbete hazır düşmesi meselesinin tamamı [WhatsApp'tan sipariş almak](/tr/blog/whatsapptan-siparis-almak) yazısında.

## Türk alıcının linke basınca baktığı üç şey daha
...
**Kapıda ödeme var mı.** Bazı kategorilerde bu soruya hayır demek konuşmayı bitiriyor. Cevabın hayırsa bile yaz, çünkü yazmadığında o kişi sana soruyor, sen cevaplıyorsun, o gidiyor, ve sen iki mesaj harcamış oluyorsun. Nasıl işlediğini ve reddedilen paketin gerçek maliyetini [kapıda ödeme nasıl çalışır](/tr/blog/kapida-odeme-nasil-calisir) yazısında hesapladık.
...
### Taksit sorusunun dürüst cevabı
...
## İlk ekranda ne duracak, neyi silsen hiçbir şey olmaz

İlk ekranda duracaklar kısa bir liste.

- Üç ya da dört ürün, fotoğrafı ve fiyatıyla beraber.
- Kargo süresi, gün olarak, il içi ve il dışı ayrı.
- Gerçekten kabul ettiğin ödeme yolları. Kabul etmediklerini de bir kelimeyle.
- Tek bir hareket. İki tane koyarsan ikisi de zayıflıyor.
...
İlk ekrandaki üç fotoğraf sayfanın geri kalanının tamamından daha çok iş yapıyor. Kırk vasat fotoğraf bir sayfayı taşımıyor, altı iyi fotoğraf bir yıl taşıyor. Tek pencereyle nasıl çekildiği [telefonla ürün fotoğrafı çekmek](/tr/blog/telefonla-urun-fotografi-cekmek) yazısında adım adım var.

## Hakkımızda metninin yerine güven bloğu koy
...
- **İade ve değişim tek cümleyle.** Mesafeli satışta tüketicinin hakları mevzuatla belirleniyor ve kurallar değişebiliyor, o yüzden kendi cümleni yazmadan önce güncel hâline ticaret.gov.tr üzerinden bak, ya da mali müşavirine sor. Sayfada yazan cümle ile kapıda söylediğin cümlenin aynı olması senin işin.
- **Kaç yıldır sattığın.** "2021'den beri" bir satır ve bedava.
- **Cevap verdiğin bir iletişim yolu.** Numara ya da e-posta. Cevap vermediğin bir numara koymak, hiç koymamaktan kötü.
- **Onaylanmış yorumlar.** Beş tane yeter.
...
## Sayfanın açılma hızı da ilk ekranın parçası
...
## Biyografi metninin kendisi 150 karakterlik bir iş
...
## Linkin adresi de bir tasarım kararı
...
## Hikâye linki ile biyografi linkinin işi ayrı
...
## Ölçmek, ve ne zaman ölçmemek

Ücretsiz planda 30 gün istatistik tutuluyor. Pro planında (9,99 USD/ay veya 95,90 USD/yıl) bir yıl tutuluyor, ve bunun tek gerçek faydası şu: geçen ağustosla bu ağustosu karşılaştırabiliyorsun. Sessiz bir ağustosun senin hatan mı yoksa herkesin ağustosu mu olduğunu başka türlü bilemiyorsun.
...
Ücretsiz planda sayfanda bir Sailo rozeti duruyor, 20 ürün sınırı var ve istatistikler 30 gün geriye gidiyor. Rozeti kaldırmak Pro'ya geçmek demek. Yirmi ürün de bedenleri ayrı ürün olarak listeleyen bir giyim satıcısı için hiçbir şey, iki hafta içinde doluyor.

Kart tarafında söylenmesi gereken şey daha net. Sailo'nun kart yöntemi Stripe üzerinde ve sadece Stripe üzerinde çalışıyor, Business planı gerektiriyor (19,99 USD/ay veya 191,90 USD/yıl), ve Sailo iskontodan sonraki mal bedelinin yüzde 0,5'ini alıyor, kargo ve vergi hariç. Para senin kendi Stripe hesabına düşüyor, hiçbir aşamada Sailo'ya uğramıyor.
...
Sayfa hazırsa ve hâlâ kimse gelmiyorsa problem sayfada değil. Ziyaretçisi olmayan mükemmel bir sayfa sayfa değil, ve ilk on siparişin nereden geldiği [ilk siparişlerini almak](/tr/blog/ilk-siparislerini-almak) yazısının konusu.
