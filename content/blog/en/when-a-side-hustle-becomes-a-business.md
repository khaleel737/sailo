---
title: When a side hustle becomes a business
description: There is no moment when a hobby turns into a business. There is a test, most tax authorities use a similar one, and you probably crossed it a while ago.
date: 2026-08-06
author: Sailo team
cover: /blog/covers/when-a-side-hustle-becomes-a-business.svg
...
## Three sellers, one obvious each way and one that matters

### Tom, records, Sheffield
...
1. She bought a second sheet tray specifically so she could do two cakes at once. That's an investment in capacity, made in order to sell more.
2. She started a separate Instagram account for the cakes, with prices in the highlights. That's advertising.
3. She raised the price from R$85 to R$120, because R$85 was losing money once she counted her Saturday. That's an intention to profit, stated in numbers.
4. She turned down a booking because she was already full that weekend. That's a capacity decision, and it's the one that gives it away.
...
## The other reason the label matters, if you're in the US
...
**Your exposure changes.** You're selling food, or something that goes on skin, or something a child might swallow, to strangers who don't know you. Whether you need cover, and what kind, is a real question with a real answer, and [insurance and what can go wrong](/en/blog/insurance-and-what-can-go-wrong) is the place to work it out rather than hoping.
...
**Registration may or may not be needed.** It's a separate question with separate triggers, and it usually arrives later than the reporting obligation does. [Do you need to register your business](/en/blog/do-you-need-to-register-your-business) sorts out which of the three things people call "registering" you actually need.
...
## The signals that make it obvious to anyone looking
...
- A shop link with prices on it
- A trading name that isn't your own name
- A supplier account, or repeat purchases from the same wholesaler
- Bulk packaging purchases
- Money spent on advertising or boosted posts
- A stall booking, a market pitch, a pop-up
- Consistent inventory buying, month after month
- A separate account, a separate phone, a separate email
...
## The order to do things in, the week you realise

Don't try to fix everything. Do these five, in this order, and the rest follows.

1. **Write down the date you think you started trading**, and one sentence on why. If it's ambiguous, pick the earlier date. You will never regret picking the earlier date.
2. **Reconstruct the money in.** Bank credits only, from that date. Ignore expenses for the first pass. This is quick and it's the number everything else hangs off.
3. **Open a second account** and route the shop's money into it from today, so the reconstruction problem stops growing. Nothing needs registering to do this.
4. **Find out your country's actual reporting requirement**, from the tax authority's own site, and write down the date you looked it up.
5. **Start recording from today**, whatever state the past is in. A clean line from now is worth more than a perfect reconstruction of last year.
