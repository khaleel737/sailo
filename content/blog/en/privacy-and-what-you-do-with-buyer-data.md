---
title: Privacy and what you do with buyer data
description: You hold more customer data than you think, mostly in your phone. What to collect, where to keep it, what to delete, and the privacy note you can copy.
date: 2026-08-06
author: Sailo team
cover: /blog/covers/privacy-and-what-you-do-with-buyer-data.svg
...
- Names, delivery addresses, phone numbers, email addresses.
- The order history that goes with them, which tells you what someone bought and when.
- Chat threads, which usually contain more than the order: a flat number, a gate code, "leave it with my neighbour Sue", a mention of who the present's for.
- Payment screenshots buyers have sent you, which often show a bank account number and a full name.
- Your bank statement, where every transfer carries a name and a reference.
- Photos: parcels with labels on them, order slips on your kitchen table, screenshots of DMs you meant to reply to.
- Whatever your courier's dashboard has kept.
...
- **Delivery address.** Yes, obviously, for physical goods.
- **Phone number.** Yes, if a rider will call. No, if you never call anyone.
- **Date of birth.** Almost never. Unless you sell something age-restricted, this is a field that exists because a form template had it.
- **Gender.** Almost never.
- **A photo of an ID.** Only if you're genuinely required to check something, and if you are, don't keep the photo after you've checked.
- **Second phone number, company name, "how did you hear about us".** Optional at most.
...
## Where it lives, and the phone problem
...
## The rules you actually have to look up
...
The general registration question for a small shop, which is different from the data question but usually asked at the same time, is in [do you need to register your business](/en/blog/do-you-need-to-register-your-business), and the UK-specific setup is in [selling online in the UK](/en/blog/selling-online-in-the-uk).

## The privacy note you can copy
...
## Screenshots, reviews and customer photos

You want to post the lovely message someone sent you. Fine. Before you do:

- **Crop out the name, the profile photo and the phone number**, or ask first. "Mind if I share this, with your name off it?" is a message people almost always say yes to.
- **Never post a parcel with the label visible.** It's a full home address at the resolution of a phone screen, and it stays up forever.
- **Ask before reposting a customer's photo of themselves**, every time, even if they tagged you. Tagging is not permission.
...
## Payment details you should never be holding
...
## Deleting, and the tax rules that stop you
...
1. Keep the order and payment records for as long as your tax rules require. Look up the number for your country rather than picking one.
2. Clear out chat threads older than a year, and the screenshots that go with them.
3. Delete draft spreadsheets, exports and "customers copy 2 final.xlsx" from your downloads folder.
4. Remove old buyers from any marketing list who haven't opened anything in a couple of years, which is good for your list quality anyway.

The record-keeping side is covered properly in [keeping records when you hate paperwork](/en/blog/keeping-records-when-you-hate-paperwork), and the retention question specifically is part of [what to do about tax on online sales](/en/blog/what-to-do-about-tax-on-online-sales).

## When someone asks what you hold, or asks you to delete it
...
## Worked example: Hannah, soap, Sheffield
...
## Do the ninety-second list tonight
