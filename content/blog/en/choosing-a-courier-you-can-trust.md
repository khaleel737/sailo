---
title: Choosing a courier you can trust
description: Pincode coverage, weight slabs, COD remittance and RTO cost decide whether a courier works for you. The rate card is the least useful page in the deck.
date: 2026-08-06
author: Sailo team
cover: /blog/covers/choosing-a-courier-you-can-trust.svg
...
## The rate card is the least useful page in the deck
...
## Your pincodes, not their pincode count
...
- Is it serviceable at all?
- Is it serviceable for **COD**, which is a separate answer and often a no?
- Is it a **reverse pickup** pincode, which is a third answer and more often a no?
- Is it surcharged as an ODA or remote location?
...
## Weight slabs, and the rounding nobody mentions
...
## COD is a loan you are making to your courier
...
Then ask the follow-up that gets ignored: what happens to a remittance that's short. You will need this. The routine for catching it is the same one you'd run on any payment rail, and it's in [how to know a bank transfer actually arrived](/en/blog/how-to-know-a-bank-transfer-actually-arrived). Substitute the courier's remittance statement for the bank statement and nothing else changes.

## RTO is where the money actually goes
...
1. **Do I pay forward and return, or just return?** Both is normal. Know which.
2. **Is the COD fee charged on an RTO?** Sometimes yes, on an order where no cash was ever collected.
3. **How many delivery attempts before it returns?** Two is common. Three is better. One is a red flag.
4. **How long does it sit before it comes back?** A parcel held for eleven days is stock you can't sell.
5. **Do I get the parcel back sealed?** Ask. Then check, because "returned" and "resellable" are different words, particularly for anything cosmetic.
...
- Do I get a named account manager, or a ticket queue?
- What's the response time on a stuck-shipment ticket, in hours?
- Is there a WhatsApp number that a person actually reads?
- What's the escalation path when the first answer is "please wait 48 hours"?
...
## Worked example: Nikhil, cotton kurtas, Jaipur
...
1. **Checked his top 30 pincodes properly.** Six of them were routing to a carrier with a two-attempt policy and a poor record in his own tracking data. He pinned those pincodes to a different carrier in the panel.
2. **Split his volume.** Metro and NCR to one carrier, tier-3 Rajasthan and MP to another with better rural reach, even though it cost ₹9 more a parcel.
3. **Started measuring RTO by state**, in a spreadsheet, monthly.
