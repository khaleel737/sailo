---
title: How to know which product to push
description: Rank by profit per hour, not by revenue and not by which one you like. Then push one product for four weeks instead of fourteen products once each.
date: 2026-08-06
author: Sailo team
cover: /blog/covers/how-to-know-which-product-to-push.svg
...
If your costing isn't solid, do that before this, because every number above depends on it and most small sellers undercount their materials by a third. [How to price what you make](/en/blog/how-to-price-what-you-make) is the prerequisite.

## If you have no sales history
...
1. **Questions.** Which product do people ask about most in DMs and comments? Questions are demand that hasn't converted yet, and they're a stronger signal than likes because asking costs effort.
2. **Saves and shares**, if your platform shows them. Someone saving a post is closer to buying than someone liking it.
3. **What people mention unprompted.** "Do you still make the green one?"
4. **What you'd sell to a stranger if you had one shot.** Your instinct here is worth more than you think, as long as you're picking for the buyer rather than for yourself.

Then test rather than commit. Push one product for two weeks and count enquiries, then push another for two weeks. Two weeks is enough to see a difference and short enough that you haven't wasted a season. If you're still at the very start of this, the volume comes first and [getting your first ten orders](/en/blog/getting-your-first-ten-orders) is the sequence for that.

## The hero and the ladder
...
- **The pinned post.** Whatever's pinned is what a new visitor sees first. Most sellers have something from January pinned.
- **The first line of your bio.** Name the product and the price. Not your values.
- **The first product on your shop page.** Order matters. People do not scroll as far as you think.
- **The first message.** When someone asks a general question, your answer mentions the hero specifically.
- **The packing note.** Every parcel that goes out carries a line about it.
- **Eight to twelve posts across the month.** Different angles on one product: made, worn, packed, compared, a customer's photo, the thing it fixes.
...
## The products to quietly retire
...
Everything else goes. A shorter catalogue converts better because a buyer facing eleven options makes no decision, and [building a catalogue people can scan](/en/blog/building-a-catalogue-people-can-scan) is about exactly that problem.

## How to tell whether the push worked
