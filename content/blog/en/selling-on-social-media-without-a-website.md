---
title: How to sell on social media without a website
description: Discovery, decision and payment happen in three different places, and you only control one of them. The honest architecture of selling without a site.
date: 2026-08-06
author: Sailo team
cover: /blog/covers/selling-on-social-media-without-a-website.svg
coverAlt: Several conversations arriving at one shop page
tags: [selling, social, channels]
---
...
## A sale happens in three places, not one
...
## Discovery is rented, and it always will be
...
- Don't build your ordering process on a feature one platform owns. If your entire checkout is an Instagram story sticker, you're one product change away from starting over.
- Post where discovery is cheap, but move the buyer to something you control before you ask for money.
- Don't spread across five platforms because a guide told you to. Two done properly beats five done at 30%.
...
## The decision happens on one page, and that page is yours
...
What actually belongs on that page, and what to cut, is its own decision. There's a full breakdown in [what to put in your bio link](/en/blog/what-to-put-in-your-bio-link).

## Payment is the part you control least and worry about most
...
- **Your face or your workshop, on camera, at least sometimes.** A single unpolished video of you packing orders does more than any badge.
- **Replies where other people can see them.** A public "sent yesterday, thank you!" from a stranger is worth more than a testimonial you typed yourself.
- **Delivery photos.** Not the product. The parcel, at someone's door, with the courier's label visible.
- **A stated turnaround you keep.** "Ships Tuesday and Friday" is stronger than "fast delivery", because one of them can be checked.
...
**Instagram** is discovery and desire. It's where people see the thing and want it. It's a poor place to run an order because you cannot prefill a message, so every order arrives as whatever the buyer felt like typing. The workarounds that actually help are in [turning Instagram DMs into orders](/en/blog/turning-instagram-dms-into-orders).

**WhatsApp** is confirmation and closing. It's where the address gets given, the total gets agreed, and the receipt gets sent. It's the best chat channel for orders precisely because a link can arrive with the message already written. Details in [how to take orders on WhatsApp](/en/blog/how-to-take-orders-on-whatsapp).

**Comments** are reach. Comment-claiming, where the first person to type "sold" or "mine" gets the item, is the cheapest distribution most small sellers have, because every claim is engagement and every reply is more of it. It's also the fastest way to sell the same jacket to two people. The mechanics, including the double-claim problem, are in [selling in comments without losing track](/en/blog/selling-in-comments-without-losing-track).
...
## The point where a chat thread stops scaling
...
- You start scrolling up in a thread to find an address.
- You send someone else's order confirmation to the wrong person.
- You can't remember whether the woman in Ikeja paid or just said she would.
- You take a day off and the backlog takes three days to clear.
- Two people have claimed the same item and both are polite about it, which is worse.
...
## When someone else's shop is the better answer
...
1. Pick your five best-selling items. Not twenty. Five.
2. Put a photograph and a price on each one. A real price, the one you'd say out loud.
3. Add the one delivery option most of your orders use, with its cost.
4. Put the link in your bio, and in your WhatsApp Business profile, and in your Instagram highlights.
5. Change your reply to "how much?" from a number to a link.
...
Once the page exists, the work moves to the channels feeding it. If orders arrive in two places at once, [taking orders in the comments and DMs together](/en/blog/taking-orders-in-the-comments-and-dms-together) covers keeping one list instead of two. If you post everywhere, [one link for every platform](/en/blog/one-link-for-every-platform) is the setup that stops you maintaining five bios. Sellers who also trade in person should read [selling offline and online at once](/en/blog/selling-offline-and-online-at-once), because stock that exists in one place and sells in two is its own problem, and [QR codes that actually get scanned](/en/blog/qr-codes-that-actually-get-scanned) if you print anything.

Two more for when it gets busy: [what to do when DMs get out of hand](/en/blog/what-to-do-when-dms-get-out-of-hand), and [selling to a group chat](/en/blog/selling-to-a-group-chat) if your buyers already live in one.
