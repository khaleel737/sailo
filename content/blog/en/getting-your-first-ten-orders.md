---
title: How to get your first ten orders
description: Your first ten orders come from people who already know you, asked one at a time, by name. Not from traffic. Here is the two-week job that gets them.
date: 2026-08-06
author: Sailo team
cover: /blog/covers/getting-your-first-ten-orders.svg
coverAlt: A funnel narrowing to a filled step
tags: [growth, selling]
---
...
## Your first ten orders are a list, not a funnel
...
A list works differently. You don't need a rate. You need names, and a reason to message each one. Rates only start meaning anything once the denominator is big enough to be stable, which is a while away yet, and [what conversion rate you should expect](/en/blog/what-conversion-rate-should-you-expect) explains why the numbers you'll read on this are mostly worthless at your size.
...
1. People who have already said "let me know when you start" or something like it. These are your first three orders and you probably have four or five of them.
2. People you've bought from, hired, or done a favour for in the last year.
3. Family who can afford it. Not all family. The ones who can afford it.
4. Group chats you're actually a member of, counted as individuals, not as a group.
5. Colleagues and former colleagues.
6. People who commented on the post where you announced you were starting.
...
## What the first message actually says
...
One more thing the first message shouldn't do: offer a discount. The temptation at zero orders is to knock 20% off to get things moving, and it works, and then you've taught forty people what your product is worth and it isn't the number on the label. If you're going to discount at all, do the arithmetic first, because [running a discount without losing money](/en/blog/how-to-run-a-discount-without-losing-money) is a margin problem before it's a marketing one.

## Get one product ready, not twenty
...
## Orders one to three: the people who owe you
...
- You didn't write down which variant they wanted, and now you're not sure.
- You quoted a price that didn't include delivery, and now you're eating the delivery.
- The payment came in under by a small amount and you don't know if it's a fee or a mistake.
- You forgot to ask for the address until the day you were meant to send it.

Fix all four before order four. The whole point of the easy sales is that they're cheap places to make mistakes.

## Orders four to seven: the people who watched it happen
...
Ask for a sentence at the same time. Not a review form, a sentence, in their words, that you have permission to screenshot. Three of those under your first product listing will do more for order eight than another week of posting, and [how to collect reviews that convince](/en/blog/how-to-collect-reviews-that-convince) is about getting the specific ones rather than the polite ones.

Then message ring two, individually, same as before. Not a broadcast post. The broadcast post is for ring three.

## Orders eight to ten: the first strangers
...
Strangers arrive through three routes at this stage, and none of them is advertising. Paying for traffic before you know that a stranger converts is buying visitors to a page that doesn't sell, and [when to spend money on ads](/en/blog/when-to-spend-money-on-ads) is mostly an argument for not doing it yet. The three routes:

- **A referral.** Someone from ring one or two sent them. This is the highest-converting traffic you will ever get and it is free, and [asking customers for referrals](/en/blog/asking-customers-for-referrals) is a specific ask with specific wording, not a vibe.
- **A comment or a share.** A post got out of your immediate circle, usually because somebody tagged someone.
- **A local search or a group.** A neighbourhood group, a WhatsApp community, a Facebook group for the specific thing you sell.

Your job at this point is to make the path from "I want that" to "I paid" as short as it can physically be. Price visible. Delivery cost visible. One tap to order. Every extra step between the post and the payment loses people you already worked for, which is the whole argument in [why your link in bio is costing you sales](/en/blog/why-your-link-in-bio-is-costing-you-sales).

## Where Chidera's first ten actually came from
...
## The question that kills the sale is "how much?"
...
## Don't build a checkout you don't need yet
...
Card payments become worth it when you're selling to people who don't know you and won't send a transfer to a stranger's account. That's usually somewhere north of order thirty, not order five. [How to take payment as a small seller](/en/blog/how-to-take-payment-as-a-small-seller) covers the rails that need nothing but a note on the page.

Here's where Sailo's own limits are worth saying out loud rather than burying. The free plan caps you at 20 products, which is plenty for a first catalogue and not plenty for a real one. Card payments need the Business plan at $19.99 a month plus 0.5% of the goods on each card order, and that subscription is the real cost at ten orders a month, not the half a percent. And there is no mobile money rail. If your buyers pay you by M-Pesa or GCash, Sailo will carry the catalogue and the order and the address, and you will still be the one checking your phone for the payment confirmation. That's a genuine gap, not a positioning statement.

## What to do if you get to forty asks and nothing happens
...
None of those is fixed by messaging harder. [What to do when nobody is buying](/en/blog/what-to-do-when-nobody-is-buying) is the diagnostic, in order, from cheapest thing to check to most expensive.

## When the first ten are done
...
After that, the job changes shape: it stops being about finding new people and starts being about making the ones you have come back. [How to get repeat buyers](/en/blog/how-to-get-repeat-buyers) is where that starts.
