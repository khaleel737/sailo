---
title: Memberships versus one-off sales for creators
description: "A membership is recurring work, not recurring revenue. The churn arithmetic, what you owe members every month, and when a one-off product wins."
date: 2026-08-06
author: Sailo team
cover: /blog/covers/memberships-versus-one-off-sales.svg
coverAlt: A parcel part way along a dotted route
tags: [creators, pricing]
---
...
## The arithmetic that makes memberships look irresistible
...
## What you actually owe a member

The unglamorous list, because this is what the decision is really about.

- **Something new, on a schedule, that they can see.** If a month goes by with nothing, people notice, and the ones who notice are the ones about to cancel.
- **Answers.** A paid community where questions sit unanswered for four days dies quietly.
- **Moderation.** One rude person in a group of 140 will cost you six members before you deal with them.
- **The admin.** Renewals, failed payments, refund requests, people who want to pause, people who cancelled and want back in at the old price.
- **A reason to still be there in month seven.** This is the hard one, and almost nobody plans for it. Month one sells itself. Month seven is a different product.
...
## The three kinds of membership that actually hold
...
There's more on the community-shaped version of this in [selling a newsletter or paid community](/en/blog/selling-a-newsletter-or-paid-community).

## When a one-off product wins
...
That bottom-right cell is the one-off model's genuine weakness, and it's real. A business made only of one-off launches is a business with no floor. The answer isn't necessarily a membership, though. It's usually a second product and a reason to come back, which is a smaller and much more reliable fix. [How to get repeat buyers](/en/blog/how-to-get-repeat-buyers) covers the mechanics.

## Worked example: Divya, Bengaluru

Divya teaches home baking. About 9,000 followers, mostly women in Bengaluru, Hyderabad and Chennai who bake on weekends and want to sell.
...
## The money mechanics nobody checks first
...
Card is the rail that finishes the job without you, and it has a price attached. It needs Sailo's Business plan at $19.99 a month plus a Stripe account Stripe has cleared for charges, and Sailo takes 0.5% of the goods on top of Stripe's own fee. On a ₹499 charge the 0.5% is about ₹2.50. That's not the cost. The cost is the $19.99, which at 143 members is trivial and at 12 members is most of your margin.
...
1. **Run it as a cohort first.** Twelve people, six weeks, fixed price, definite end. You'll learn everything a membership would have taught you in a tenth of the time, and if it doesn't work you haven't promised anyone a year.
2. **Price it so 40 members is a real income.** If your plan needs 400 members to matter, you're building a media company. At ₹2,000 a month, 40 members is ₹80,000. At ₹299, it's ₹11,960 and 40 people's expectations.
3. **Decide the schedule and halve it.** Whatever you think you can produce, you'll produce less. Weekly becomes monthly by March. Promise monthly.
4. **Cap it.** A closed group of 60 with a waiting list is easier to run, easier to sell and much harder to leave than an open one of 300.
5. **Write the exit before the launch.** How people cancel, what happens to their access, and what you'd do if you wanted to stop. You'll need it eventually and you won't want to write it then.

## The version most working creators actually run
...
That stack, and what a genuinely liveable month contains, is laid out in [the creator middle class](/en/blog/the-creator-middle-class). If you haven't picked a price for any of it yet, start with [how to price your first paid offer](/en/blog/how-to-price-your-first-paid-offer). And the wider map of which routes a small audience can support at all is in [turning an audience into income](/en/blog/turning-an-audience-into-income).
