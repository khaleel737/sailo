---
title: Do you need to register your business to sell online
description: Most people can sell legally without registering anything first. What matters is knowing which trigger forces your hand, and what registering really changes.
date: 2026-08-06
author: Sailo team
cover: /blog/covers/do-you-need-to-register-your-business.svg
coverAlt: An invoice with the total set apart at the bottom
tags: [admin, starting-out]
---
...
## Three different things get called "registering"
...
## You're probably a business already, whether or not you filed anything
...
- **There's no line between you and the business.** Your shop's debts are your debts. If a customer sues, they sue you.
- **The income is your income.** It goes on your personal return alongside anything else you earn.
- **The name is your name**, unless you register a trading name separately. In a lot of places you can trade as "Coastal Candle Co" while being legally just yourself, and in a lot of places that alone needs a filing.
- **Your obligations start when you start trading**, not when you register. Registering late doesn't move the start date, which is why people who register in year two sometimes get asked about year one.

Whether you've already crossed from "selling some stuff" into "trading" is a genuinely separate question with a genuinely separate test, and it matters more than the registration question does. [When a side hustle becomes a business](/en/blog/when-a-side-hustle-becomes-a-business) works through the indicators tax authorities actually use.

## The four triggers that force the decision

Nobody registers because they read something. They register because they hit one of these.

### 1. A bank hands the form back
...
That proof is the registration certificate. This is the single most common reason small sellers register, and it's a good one, because mixing business and personal money is the mistake that costs the most and is noticed the latest. You don't need a corporate account to stop mixing, though. [Separating business and personal money](/en/blog/separating-business-and-personal-money) covers the version you can do this afternoon with a second personal account, and when the corporate one becomes worth the paperwork.

### 2. A business customer needs an invoice they can process
...
This is the trigger that arrives with money attached, which makes it the most persuasive one. Get the requirements from their finance contact *before* you deliver, not after. [Invoices that get paid](/en/blog/invoices-that-get-paid) has the field list and the chase sequence. If you're in Germany or anywhere else in the EU, the invoice content rules are stricter than you're expecting and they're a separate anxiety worth handling on its own: [VAT and invoicing anxiety](/en/blog/vat-and-invoicing-anxiety) untangles the three obligations people usually feel as one.

### 3. A processor runs its checks
...
There's a fifth item people put on this list that doesn't belong: registering does not, by itself, get you insured. Cover is a separate purchase with its own questions about what you make and who could be harmed by it, and [insurance and what can go wrong](/en/blog/insurance-and-what-can-go-wrong) is the place to think that through.

And one honest non-benefit: registering does not make you look more legitimate to a normal buyer. Almost no consumer checks. What makes a stranger comfortable enough to send money is a page that answers their questions, real photos, a refund position they can read, and a reply that arrives the same day. [Proving you are a real seller](/en/blog/proving-you-are-a-real-seller) is a better use of an afternoon than a filing fee if buyer trust is the actual problem.

## What it costs, including the part nobody mentions
...
- **An annual filing, forever**, in most entity structures, whether or not you traded. Miss it and you get penalties for a company that made nothing.
- **A separate return** for the entity, on top of your personal one.
- **An accountant**, eventually, because the second return is the point where most people stop doing this themselves.
- **A closing process** if you stop. Dissolving a company you no longer use is its own small pile of admin, and people who registered too early discover this two years later.
...
There's a decent test for whether you can afford any of it. Work out what a month of your shop actually leaves you after materials, packaging, postage, fees and the subscription, because an annual filing plus an accountant is a fixed cost and fixed costs land hardest on small volumes. [Working out if you are actually profitable](/en/blog/working-out-if-you-are-actually-profitable) has the full arithmetic on one basket, and it's a sobering read before you add a permanent line to the outgoings.

## Danielle, resin coasters, Columbus
...
## What to look up, in your own country, in twenty minutes

Skip the blogs. Go to your tax authority's own site and your business registry's own site, and answer these in writing:

1. Does my country treat an unregistered individual who sells things as a default structure, and what's it called?
2. Is there an income level below which I don't have to report trading income at all? Find the current figure, not one from an article.
3. If I want to trade under a name that isn't my own, does that name need registering separately from an entity?
4. What does my bank require for an account in a business name? This is on the bank's site, not the government's.
5. Does my product category need a licence, permit or inspection? Search by product, then by how you sell it.
6. What are the annual obligations if I register an entity, and what's the penalty for missing one?
...
Then read the rest of it with numbers in front of you rather than from memory. [What to do about tax on online sales](/en/blog/what-to-do-about-tax-on-online-sales) covers how the reporting actually works once you're trading, and [keeping records when you hate paperwork](/en/blog/keeping-records-when-you-hate-paperwork) is the ten-minutes-a-week system that makes any of it survivable.

## The honest position on getting this wrong
...
## What Sailo will and won't do here
