---
title: Marketplace seller fees compared, layer by layer
description: The headline commission is never what you pay. Five layers of fee, what each one is charged on, and how to work out your real all-in rate per order.
date: 2026-08-06
author: Sailo team
cover: /blog/covers/marketplace-fees-compared.svg
...
## The five layers, and what each is charged on
...
- Is it charged on the item price, or the item price plus delivery?
- Is it charged before or after any discount you ran?
- Does it include tax collected from the buyer?
...
### Layer three: payment processing
...
The fixed amount is what hurts cheap products. PayPal's US commercial rate on 6 August 2026 was 3.49% + $0.49, with an extra 1.5% cross-border and a 4% currency conversion spread. On a $6 item, that $0.49 alone is over 8%. On a $60 item it's under 1%. Any fee with a fixed component is a tax on small baskets, which is the whole argument in [how payment fees eat a small order](/en/blog/how-payment-fees-eat-a-small-order).

### Layer four: advertising
...
### Layer five: fulfilment and returns
...
## What I could verify on 6 August 2026, and what I couldn't
...
## Work out your own all-in rate in ten minutes
...
## Rina in Cebu, and the fee she didn't see coming
...
## When the commission is worth every unit of currency you pay it
...
The way to find out is to ask. Add one question to your packing note: how did you find me? Two months of answers will tell you what fraction of your fees are buying you anything. The wider version of that argument is in [when a marketplace beats your own shop](/en/blog/when-a-marketplace-beats-your-own-shop).

## What Sailo charges, and where it loses
...
## Do this before your next payout
...
If your all-in rate surprised you, the arithmetic on where a percentage stops beating a flat fee is worked out at 10, 50 and 300 orders a month in [what a commission actually costs you](/en/blog/what-a-commission-actually-costs-you). And if the answer is that you want more of your orders coming through a channel you control, the thing that makes that possible is [owning your customer list](/en/blog/owning-your-customer-list). The four categories of tool that could hold that channel are compared in [link in bio tools compared](/en/blog/link-in-bio-tools-compared).
