---
title: VAT and invoicing anxiety
description: Three German obligations get felt as one lump of dread. The Impressum, the invoice rules and VAT have different triggers and different fixes.
date: 2026-08-06
author: Sailo team
cover: /blog/covers/vat-and-invoicing-anxiety.svg
...
## The Impressum is the one that bites first
...
## What a German invoice has to say
...
The general shape of a document that gets paid, as opposed to one that's merely legal, is in [invoices that get paid](/en/blog/invoices-that-get-paid). Compliance and getting paid on time are two different problems and it's worth solving both.

## VAT, and the simplification built for you
...
### Not charging VAT isn't automatically the good option
...
### The part that actually hurts people
...
Cross-border selling has plenty of other sharp edges beyond tax, from customs paperwork to returns, and [selling across borders for the first time](/en/blog/selling-across-borders-for-the-first-time) covers the wider set.

## Lena, embroidered patches, Leipzig
...
## When to pay a Steuerberater, and what to ask
...
1. Given my turnover and what I sell, should I use the small-business simplification, and what are this year's figures?
2. What has to be on my invoices for what I actually sell, and can you look at one of mine?
3. What do I need to be tracking monthly so I see a threshold coming?
4. I sell to buyers in other EU countries. What changes, and at what point?
5. What are my retention obligations and in what format?
...
## What Sailo does, and the parts it leaves to you
...
One more, unrelated to Germany but relevant to the cost of all this: card payments need the Business plan at $19.99 a month plus a Stripe account cleared for charges, and Sailo takes 0.5% of the goods on card sales. At 150 orders a month averaging €8, that 0.5% is small change and the subscription is the real number. At 15 orders a month it isn't worth turning on.
...
If the more basic question of whether you should be registering anything at all is still open, [do you need to register your business](/en/blog/do-you-need-to-register-your-business) sorts that out, and [what to do about tax on online sales](/en/blog/what-to-do-about-tax-on-online-sales) covers the profit side, which is a separate obligation from the VAT one and gets confused with it constantly.
