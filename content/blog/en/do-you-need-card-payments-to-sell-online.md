...
If you're doing fewer than about twenty card-eligible orders a month, you almost certainly don't need them. Card payments on Sailo need the Business plan at $19.99 a month, plus 0.5% of the goods, plus whatever your processor charges. At eight orders a month averaging $30, that $19.99 works out at 8.3% of your card revenue before a single processing fee. No gateway on earth charges 8.3%.
...
Add your processor's rate and Sailo's 0.5% to whichever cell you landed in. That's your true all-in cost of taking cards.
...
Cards are for the second pile. If the second pile is small, cards will not grow your revenue, they'll just reprice the revenue you already have. If the second pile is most of your orders and you're losing some of them at the payment step, cards are probably the highest-return $19.99 you can spend.
...
The case against upgrading, in her numbers: 14 orders at £29 is £406 of card-eligible revenue a month. The $19.99 subscription is somewhere near 5% of that. Add roughly 1.5% + 20p from Stripe and 0.5% to Sailo, and she'd be paying about 7.5% all in to solve a problem she described as "checking my banking app while the kettle boils".
...
One detail from her first card month that's worth stealing: her postage is £4.50 and Sailo's 0.5% doesn't apply to delivery, only to the goods after discount. On a £33.50 order she pays 15p to Sailo, not 17p. Two pence, which is nothing, except that knowing exactly what's charged on what is how you stop being nervous about a number you can't predict.
