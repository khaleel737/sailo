---
title: What should I sell online
description: Not a list of ideas. A way of deciding, built on what you can source, what you can ship without it breaking, and what people have already asked you for.
date: 2026-08-06
author: Sailo team
cover: /blog/covers/what-should-i-sell-online.svg
coverAlt: A grid of catalogue cards with one picked out
tags: [starting-out, products]
---
...
## "Pick a profitable niche" is mostly worthless advice
...
## Filter one: what can you actually get
...
- **What's the lead time from deciding to having it in your hands?** Include payment clearing, production, freight and customs.
- **What's the minimum order?** Not the ideal order. The smallest quantity anyone will sell you.
- **How stable is the price?** Anything imported carries a currency risk you're not being paid to take.
- **How many other people in your city buy from the same source?** If the answer is "everyone", your differentiation has to come from somewhere else, and usually that somewhere else is your own time.
- **What happens when they go quiet for three weeks?** Because they will.
...
That third row is where most resale businesses live and it's the one people underestimate. Sourcing thrifted clothing, second-hand phones or vintage furniture isn't a step before the business, it *is* the business, and the people who do it well are spending most of their week finding stock rather than selling it. [How to sell thrift clothes online](/en/blog/selling-thrift-and-vintage-clothes) and [how to sell used phones online safely](/en/blog/selling-second-hand-electronics) both start from that reality rather than from the listing.

There's a fourth answer that sounds like it removes the problem entirely: let someone else make and ship it on demand. It does remove the capital and the stock risk, and replaces them with a thin margin and a delivery time you don't control. [Print on demand without the hype](/en/blog/print-on-demand-without-the-hype) does that arithmetic honestly.

## Filter two: what can you actually deliver
...
**How heavy and how big is it?** Couriers price on both, and volume usually bites before weight. A restored armchair is a local-delivery business whether you wanted one or not. [How to sell restored furniture](/en/blog/selling-furniture-you-restore) is written around that constraint rather than around the restoring.
...
**Is it alive or perishable?** Plants, food, flowers and anything with a shelf life turn a delivery delay into a total loss rather than an annoyance. That doesn't rule them out. It means your courier choice and your cutoff times are part of the product design from day one, which is why [how to sell plants online](/en/blog/selling-plants-without-killing-them) and [how to sell baked goods from home](/en/blog/how-to-start-selling-baked-goods) spend so long on the box.

**How many variants does it need?** Sizes and colours multiply your stock, your photography and your returns. Apparel and footwear are the extreme case: the same product in eight sizes is eight products, and the ones that don't sell are the small and large ends of the run every time. [How to sell sneakers online](/en/blog/selling-shoes-and-sneakers) covers what that does to your money.
...
## Filter three: what are people already asking you for
...
- **Your DMs.** Scroll back three months and count the questions. Not compliments. Questions about availability, price, sizes, whether you do X.
- **What people ask you to do for free.** The thing friends ask you to help with is a service with demand attached. Baking, photography, fixing things, sewing, tutoring, doing someone's hair.
- **What you already sell that people ask to buy more of.** The easiest new product is a second version of the one that works.
- **What's missing where you live.** A gap you noticed as a customer is a gap you can describe accurately, which is worth more than a gap you read about.

That last route is how most durable small businesses actually begin. Somebody made something for themselves or a friend, someone else asked for one, and it happened twice. [How to sell handmade jewellery](/en/blog/selling-handmade-jewellery-online) and [how to take cake orders online](/en/blog/running-a-small-cake-business) are both, at root, that story with the logistics attached.

And it applies just as much when what you sell isn't an object. Selling your hours has no sourcing problem, no delivery problem and no stock risk, which removes two of the four filters entirely. What it has instead is a hard ceiling, because you only have so many Saturdays. [How to sell tutoring online](/en/blog/tutoring-and-selling-your-hours) and [how to take bookings for a home service](/en/blog/running-a-cleaning-or-repair-service) both start from that trade. And a commission-based creative practice sits in the same shape, with the added problem of quoting for work whose scope moves: [how to sell art commissions online](/en/blog/selling-digital-art-and-commissions) is about pricing that honestly.
...
## Filter four: what does your market actually pay
...
## Ope in Ibadan, three candidates, one table
...
## The three-week test that costs almost nothing
...
## What Sailo does here, and what it can't
