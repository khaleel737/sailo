---
title: You do not need 100k followers
description: The follower count you need to start selling is one buyer. Where the 100k myth came from, what each audience size really supports, and how to test yours.
date: 2026-08-06
author: Sailo team
cover: /blog/covers/you-do-not-need-100k-followers.svg
coverAlt: A crowd with a few picked out
tags: [creators, audience]
---
...
## The 100k myth is brand-deal economics wearing a disguise
...
Those two sentences describe two different businesses, and almost all the confusion in creator advice comes from mixing them. The even-handed version of that choice is in [brand deals versus selling your own thing](/en/blog/brand-deals-versus-selling-your-own-thing), because brand deals are not a worse option, just a different one.

## What each audience size actually supports
...
## Reach is not followers, and trust is not either
...
## Worked example: Bea, maths tutor, Manila
...
## The thing that changes as you grow, and the thing that doesn't

What genuinely improves with size:

- **Discovery.** More people find you without you doing anything. This is real and it matters.
- **Brand interest.** Below a few thousand, most inbound brand messages are affiliate spam or free-product-in-exchange-for-posts.
- **Social proof.** A buyer who sees 12,000 followers hesitates slightly less than one who sees 900. Slightly.

What doesn't improve:

- **Your conversion rate.** Bigger audiences are usually less engaged, not more. The person who followed you last week is worth less than the one who's been there a year.
- **Your ability to deliver.** If you can do six calls a week at 1,000 followers, you can do six at 50,000, and the extra 49,000 people just make the waiting list longer.
- **Your pricing power**, unless the growth came from work that demonstrated competence. Fame from one viral clip about something unrelated buys you nothing.
...
## The test that beats counting followers

Before you decide you're too small, run this. It takes a week and it costs nothing.

1. **Write your offer in one sentence with a price.** "60-minute algebra session, ₱1,500, Tuesday or Thursday evening."
2. **Post it once, plainly.** No launch, no countdown, no story sequence. Just the sentence and a way to reply.
3. **Count three things:** how many people saw it, how many replied, how many asked how to pay.
4. **Wait 72 hours.** Do not post it again, do not explain it, do not apologise for it.

Interpretation:

- **Two or more people asked how to pay.** You have a business. Go set up a way to be paid today.
- **People replied with questions but nobody asked about payment.** The offer isn't clear or the price doesn't match the promise. That's a rewrite, not a growth problem.
- **Nobody replied at all, but reach was normal.** Either the audience is wrong for this offer, or they don't yet believe you can deliver it. Both are fixable and neither is about follower count.
- **Reach was a tenth of normal.** The post did badly, which tells you nothing about the offer. Try again in a fortnight.

The reasons behind a silent post are more varied than most people assume, and guessing wrong costs months. [Why your audience does not buy](/en/blog/why-your-audience-does-not-buy) goes through the causes in the order they actually occur.

## The cost of waiting until you're bigger
...
## The honest limits of starting small
...
## Where the follower number does matter
...
If you're not sure what that offer should be, start from the map in [turning an audience into income](/en/blog/turning-an-audience-into-income), then work out the number in [how to price your first paid offer](/en/blog/how-to-price-your-first-paid-offer). Both take less time than another month of growing.
