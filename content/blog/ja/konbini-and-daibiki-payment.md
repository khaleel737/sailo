...
先に事実を書きます。**Sailo にコンビニ払いのレールはありません。**これは無料プランの制限ではなく、Business プラン（$19.99/月）にしても出てきません。使える支払い方法は、カード、WhatsApp、Telegram、Instagram、メール、電話、銀行振込、代金引換。これで全部です。PayPay も LINE Pay もありません。LINE そのものも入っていません。
...
カード決済という選択肢もありますが、条件があります。Business プラン（$19.99/月、年払い $191.90）と、Stripe に承認された接続済みアカウントの両方が必要です。手数料は商品代の 0.5%（割引後の商品代にかかり、送料と税は対象外）。お金は Sailo を通らず、あなたの Stripe アカウントに入ります。
