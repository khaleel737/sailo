...
無料プランは $0 で商品20点まで、分析は30日分。手動の支払い方法とチャット経由の注文は使えますが、カード決済はありません。カードを出すには Business プラン（$19.99/月、年払い $191.90）と、Stripe に承認された接続済みアカウントの両方が必要です。手数料は商品代の 0.5%（割引後の商品代にかかり、送料と税は対象外）。
...
最初の十件に関して言えば、カードは要りません。前払いの銀行振込と代金引換で足ります。月に $19.99 を払うのは、件数が増えて「カードが無いから買わない人」が見えてきてからで十分です。コンビニ払いを求められたときの答えは[コンビニ払いと代金引換を売り手の側から見る](/ja/blog/konbini-and-daibiki-payment)に書きました。
