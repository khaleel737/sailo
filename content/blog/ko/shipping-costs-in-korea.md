...
사일로에서 카드 결제를 쓰면 사일로가 상품 금액의 0.5%를 가져갑니다. 할인 적용 후 상품 금액 기준이고, **배송비와 세금은 제외**입니다. 그러니까 택배비를 별도 항목으로 세워 두면 그 금액에는 0.5%가 안 붙고, 상품가에 녹이면 붙습니다.
...
| 도서산간 추가금 | 요금표에서 확인 |
| 박스와 완충재 | 실제 구매 단가 |
| 카드 결제 시 사일로 수수료 | 상품 금액의 0.5%, 배송비 제외 |

마지막 줄에 대해 덧붙이면, 사일로에서 카드 결제를 쓰려면 Business 플랜이 필요합니다. 월 $19.99 또는 연 $191.90이고, 결제 승인을 받은 Stripe 계정을 연결해야 합니다. 카드 대금은 사일로를 거치지 않고 판매자 본인의 Stripe 계정으로 들어갑니다.
...
배송비를 상품 가격에 녹이는 방식은 손님에게는 깔끔하지만 판매자에게는 세 가지를 숨깁니다. 카드로 받을 때 0.5%가 그 금액에도 붙고, 택배 요금이 오르면 전 상품 가격을 다시 짜야 하고, 실제 배송 원가가 얼마인지 장부에서 안 보입니다.
